...
Security fixes land on the **current published train** (`0.46.x`). Older `0.x` lines should
...
4. Fixes land on the current published train (`0.46.x`); see Supported versions above.
