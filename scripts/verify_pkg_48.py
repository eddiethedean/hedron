...
def _check_versions(*, allow_planned: bool) -> None:
    ...
    elif published.startswith(("0.49.", "0.50.", "0.51.", "0.52.", "0.53.", "0.54.", "0.55.", "0.56.", "0.57.", "0.58.", "0.59.", "0.58.", "0.59.", "0.58.", "0.59.", "0.58.", "0.59.", "0.58.", "0.59.", "0.58.", "0.59.")):
        print(f"ok: 0.48 historical under living published {published}")
        return
    else:
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.allow_planned:
        ...
        ("0.49.", "0.50.", "0.51.", "0.52.", "0.53.", "0.54.", "0.55.", "0.56.", "0.57.", "0.58.", "0.59.", "0.58.", "0.59.", "0.58.", "0.59.", "0.58.", "0.59.", "0.58.", "0.59.", "0.58.", "0.59.")
    ):
        errors = release_gate.check_evidence_manifest(GATE)
        if errors:
            raise SystemExit("\n".join(errors))
        print("ok: 0.48 verified historical packet")
    else:
        command = [
            sys.executable,
