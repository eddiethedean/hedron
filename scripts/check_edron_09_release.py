...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        if version != "0.9.1" or args.version != version:
            _fail(f"expected Edron 0.9.1, found {version}")
        ...
        return 1
    print("Edron 0.9.1 release artifacts are valid on Hedron 0.67.0 through 1.x")
    return 0
