...
| `verify_pkg_43.py` / `verify_pkg_42.py` / `verify_pkg_41.py` / `verify_pkg_40.py` / … / `verify_pkg_10.py` | Phase-tied package verify helpers (living tip cut: **`verify_pkg_44.py`**; phase 0.45 remains Planned in `release-gate-0.45.toml`) |
