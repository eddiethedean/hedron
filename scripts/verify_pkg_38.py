...
def _check_versions(*, allow_planned: bool) -> None:
    ...
    if allow_planned:
        if not (
            ...
            or version.startswith(("0.46.", "0.47.", "0.48."))
        ):
            raise SystemExit(
                f"unexpected workspace version {version!r}; Stage 0/history expects 0.37.x–0.47.x"
            )
    ...
    if version.startswith(("0.39.", "0.40.", "0.41.", "0.42.", "0.43.", "0.44.", "0.45.", "0.46.", "0.47.", "0.48.")):
