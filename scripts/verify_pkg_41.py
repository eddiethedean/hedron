...
if version not in {"0.41.0", "0.42.0", "0.43.0", "0.44.0", "0.45.0", "0.46.0", "0.47.0"} and not version.startswith(
    ("0.42.", "0.43.", "0.44.", "0.45.", "0.46.", "0.47.")
):
    raise SystemExit(
        f"workspace version must be 0.41.0 or post-cut 0.42.x/0.43.x/0.44.x/0.45.x/0.46.x/0.47.x, got {version}"
    )
