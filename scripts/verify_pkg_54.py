...
def _check_versions(*, allow_planned: bool) -> None:
    ...
    if allow_planned:
        ...
        return
    if published.startswith(("0.55.", "0.56.", "0.57.", "0.58.", "0.59.", "0.60.", "0.61.", "0.62.", "0.63.")):
    ...
    if status == "uploaded":
        ...
        if not (pypi.startswith("0.51.") or pypi.startswith("0.52.") or pypi.startswith("0.53.")):
            raise SystemExit(f"deferred pypi_version must stay on 0.51.x–0.53.x; found {pypi!r}")
    else:
