...
Multi-worker production kitchen-sink sample for the current Hedron train (**0.60**).
...
`hedron[charts]>=0.60.0,<0.61` to obtain the compatible chart satellite.
...
- Charts via workspace `hedron-charts` or published `hedron[charts]>=0.60.0,<0.61`
