...
class ShowcasePage(ed.Page):
    ...
    def shell(self, current: type[ed.Page]) -> None:
        with self.sidebar:
        ...
        self.heading("Command center" if current is Overview else current.__name__)
        self.caption("A complete operations workspace composed from Edron page methods.")
