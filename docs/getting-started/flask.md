...
Pin from PyPI `hedron>=0.54.0,<0.55` (or `hedron-flask>=0.54.0,<0.55`).
...
uvx --from "hedron>=0.54.0,<0.55" hedron new my-flask-app --flask
...
python -m pip install "hedron-flask>=0.54.0,<0.55"
```
