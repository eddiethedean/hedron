...
public PyPI release, `hedron-flask>=0.56.0,<0.58`, until the 0.56 upload lands.
Pin from PyPI `hedron>=0.56.0,<0.58` (or `hedron-flask>=0.56.0,<0.58`).
...
uvx --from "hedron>=0.56.0,<0.58" hedron new my-flask-app --flask
...
python -m pip install "hedron-flask>=0.56.0,<0.58"
```
