...
**Install:** `pip install "hedron-flask>=1.0.1,<1.1"` (or `uv add "hedron-flask>=1.0.1,<1.1"`).
...
uvx --from "hedron>=1.0.1,<1.1" hedron new my-flask-app --flask
...
python -m pip install "hedron-flask>=1.0.1,<1.1"
```
