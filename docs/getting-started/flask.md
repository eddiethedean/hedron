...
**Install:** `pip install "hedron-flask>=0.63.0,<0.64"` (or `uv add "hedron-flask>=0.63.0,<0.64"`).
...
uvx --from "hedron>=0.63.0,<0.64" hedron new my-flask-app --flask
...
python -m pip install "hedron-flask>=0.63.0,<0.64"
```
