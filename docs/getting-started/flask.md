...
**Install:** `pip install "hedron-flask>=0.60.2,<0.61"` (or `uv add "hedron-flask>=0.60.2,<0.61"`).
...
uvx --from "hedron>=0.60.2,<0.61" hedron new my-flask-app --flask
...
python -m pip install "hedron-flask>=0.60.2,<0.61"
```
