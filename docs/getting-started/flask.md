...
**Install:** `pip install "hedron-flask>=0.64.0,<0.65"` (or `uv add "hedron-flask>=0.64.0,<0.65"`).
...
uvx --from "hedron>=0.64.0,<0.65" hedron new my-flask-app --flask
...
python -m pip install "hedron-flask>=0.64.0,<0.65"
```
