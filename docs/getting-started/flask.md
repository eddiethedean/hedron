...
**Install:** `pip install "hedron-flask>=0.61.0,<0.62"` (or `uv add "hedron-flask>=0.61.0,<0.62"`).
...
uvx --from "hedron>=0.61.0,<0.62" hedron new my-flask-app --flask
...
python -m pip install "hedron-flask>=0.61.0,<0.62"
```
