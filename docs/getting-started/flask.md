...
public PyPI release, `hedron-flask>=0.56.0,<0.57`, until the 0.56 upload lands.
Pin from PyPI `hedron>=0.56.0,<0.57` (or `hedron-flask>=0.56.0,<0.57`).
...
uvx --from "hedron>=0.56.0,<0.57" hedron new my-flask-app --flask
...
python -m pip install "hedron-flask>=0.56.0,<0.57"
```
