...
Flask/Django page + fragment routing and HTMX are Supported on **0.17.0**. Prefer
...
python -m pip install "hedron-flask>=0.17.0"
# or: uv init my-flask-app && cd my-flask-app && uv add "hedron-flask>=0.17.0"
```
