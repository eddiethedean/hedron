...
**Published in-tree `v0.47.0`.** Pin `hedron>=0.47.0,<0.48` (or `hedron-flask>=0.47.0,<0.48`).
...
uvx --from "hedron>=0.47.0,<0.48" hedron new my-flask-app --flask
...
python -m pip install "hedron-flask>=0.47.0,<0.48"
```
