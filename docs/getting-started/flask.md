...
**Install:** `pip install "hedron-flask>=1.0.0"` (or `uv add "hedron-flask>=1.0.0"`).
...
uvx --from "hedron>=1.0.0" hedron new my-flask-app --flask
...
python -m pip install "hedron-flask>=1.0.0"
```
