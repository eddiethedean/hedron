...
**Install:** `pip install "hedron-flask>=0.62.0,<0.63"` (or `uv add "hedron-flask>=0.62.0,<0.63"`).
...
uvx --from "hedron>=0.62.0,<0.63" hedron new my-flask-app --flask
...
python -m pip install "hedron-flask>=0.62.0,<0.63"
```
