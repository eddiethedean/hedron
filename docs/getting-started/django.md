...
**Install:** `pip install "hedron-django>=0.62.0,<0.63"` (or `uv add "hedron-django>=0.62.0,<0.63"`).
...
uvx --from "hedron>=0.62.0,<0.63" hedron new my-django-app --django
...
```bash
pip install "hedron-django>=0.62.0,<0.63" "django>=5.2,<6"
```
