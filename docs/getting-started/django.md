...
**Install:** `pip install "hedron-django>=0.61.0,<0.62"` (or `uv add "hedron-django>=0.61.0,<0.62"`).
...
uvx --from "hedron>=0.61.0,<0.62" hedron new my-django-app --django
...
```bash
pip install "hedron-django>=0.61.0,<0.62" "django>=5.2,<6"
```
