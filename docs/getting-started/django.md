...
**Install:** `pip install "hedron-django>=0.58.0,<0.60"` (or `uv add "hedron-django>=0.58.0,<0.60"`).
...
uvx --from "hedron>=0.58.0,<0.60" hedron new my-django-app --django
...
```bash
pip install "hedron-django>=0.58.0,<0.60" "django>=5.2,<6"
```
