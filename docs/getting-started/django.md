...
**Install:** `pip install "hedron-django>=0.63.0,<0.64"` (or `uv add "hedron-django>=0.63.0,<0.64"`).
...
uvx --from "hedron>=0.63.0,<0.64" hedron new my-django-app --django
...
```bash
pip install "hedron-django>=0.63.0,<0.64" "django>=5.2,<6"
```
