...
**Install:** `pip install "hedron-django>=0.64.0,<0.65"` (or `uv add "hedron-django>=0.64.0,<0.65"`).
...
uvx --from "hedron>=0.64.0,<0.65" hedron new my-django-app --django
...
```bash
pip install "hedron-django>=0.64.0,<0.65" "django>=5.2,<6"
```
