...
**Published in-tree `v0.47.0`.** Pin `hedron>=0.47.0,<0.48` (or `hedron-django>=0.47.0,<0.48`).
...
uvx --from "hedron>=0.47.0,<0.48" hedron new my-django-app --django
...
```bash
pip install "hedron-django>=0.47.0,<0.48" "django>=5.2,<6"
```
