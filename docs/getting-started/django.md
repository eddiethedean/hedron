...
**Install:** `pip install "hedron-django>=0.60.2,<0.61"` (or `uv add "hedron-django>=0.60.2,<0.61"`).
...
uvx --from "hedron>=0.60.2,<0.61" hedron new my-django-app --django
...
```bash
pip install "hedron-django>=0.60.2,<0.61" "django>=5.2,<6"
```
