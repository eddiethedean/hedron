...
This documentation is **0.50.0**. Pin `hedron>=0.50.0,<0.51` (or `hedron-django>=0.50.0,<0.51`).
...
uvx --from "hedron>=0.50.0,<0.51" hedron new my-django-app --django
...
```bash
pip install "hedron-django>=0.50.0,<0.51" "django>=5.2,<6"
```
