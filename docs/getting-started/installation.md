...
Hedron **1.0.16** is published on PyPI. The three useful requirement styles are:
...
| Recommended application range | `hedron>=1.0.16,<1.1` | Starting an app on the current stable train |
| Exact reproducible version | `hedron==1.0.16` | Locking production, CI, or evidence collection |
