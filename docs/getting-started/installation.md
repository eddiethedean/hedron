...
| Recommended application range | `hedron>=1.1.2,<1.2` | Starting an app on the current stable train |
| Exact reproducible version | `hedron==1.1.2` | Locking production, CI, or evidence collection |
