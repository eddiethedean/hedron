...
This documentation describes **0.51.0** on **PyPI**. **Install from PyPI** unless you
are developing Hedron itself.

| You are… | Install |
|---|---|
| Building an app from PyPI | `hedron>=0.51.0,<0.52` |
| Working in this repository | `uv sync` (editable `0.51.0`) |
...
This checkout is **0.51.0**. Application installs from PyPI use
`hedron>=0.51.0,<0.52`.
