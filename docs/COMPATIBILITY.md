...
**Status:** Accepted for the **0.62.x** train, with in-tree tip `v0.62.0`; latest PyPI `v0.61.0`.
**Reviewed:** 2026-08-18
...
stay on the living `0.62.x` train (in-tree tip `v0.62.0`; latest PyPI `v0.61.0`). Independent Beta packages
