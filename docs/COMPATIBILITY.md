...
**Status:** Accepted for the **0.31.x** train (**Published**; last published
PyPI/git = `v0.30.0`)
**Reviewed:** 2026-08-11
...
stay on the `0.30.x` train (Published as `0.30.0`; last published
PyPI/git = `v0.30.0`). Independent Beta packages
