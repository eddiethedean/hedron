...
**Status:** Accepted for the **0.60.x** train, with in-tree tip `v0.60.0`; latest PyPI `v0.59.0`.
**Reviewed:** 2026-08-18
...
stay on the living `0.60.x` train (in-tree tip `v0.60.0`; latest PyPI `v0.59.0`). Independent Beta packages
