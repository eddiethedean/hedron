...
| Web Component platform (RFC-0060; D-064; extends RFC-0021 / 0025) | Accepted ABI plus `ElementStateOwnership`, `InteractionState`, `OptimisticMutation`, `GestureOverlayCatalog`, `ReactMigrationMatrix`, SSR/HTMX lifecycle, rich surfaces, authoring, composition, and stable inventory | [Platform](implementation/WEB_COMPONENT_PLATFORM.md) + [interaction contracts](implementation/WEB_COMPONENT_INTERACTION_CONTRACTS.md) — phases 0.36–0.41; **0.36 Stage 0 refined** ([#92](https://github.com/eddiethedean/hedron/issues/92)–[#97](https://github.com/eddiethedean/hedron/issues/97)) | [Web Component platform acceptance](acceptance/WEB_COMPONENT_PLATFORM.md) · [RELEASE_0_36](acceptance/RELEASE_0_36.md) · [release-gate-0.36.toml](acceptance/release-gate-0.36.toml) — Planned `ABI-036`…`PKG-036` |
