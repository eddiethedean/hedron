...
| Accessibility engineering / inclusive authoring (0051–0055; RFC-0023 umbrella) | `AccessibilityContract` / profile / scenarios / Explorer a11y / PE / landmarks / Page scripts / governance | Published as phase 0.19 (`v0.19.0`); available on the living `0.30.x` train | [release-gate-0.19.toml](acceptance/release-gate-0.19.toml) |
...
| Unified Posit deployment adapter (RFC-0066; D-061; extends RFC-0062 / 0063) | `hedron-posit`, one `HedronPosit` facade for ordinary Hedron, Workbench, and Connect; one-way `hedron-workbench` compatibility; native Connect; Supported authenticated bridge **dropped** after Stage 0 (`BRIDGE_DECISION=drop_supported`) | Implemented — phase 0.33 **Published** (`v0.34.0`; [#167](https://github.com/eddiethedean/hedron/issues/167)) | Verified `CONTRACT-033`…`REALCONNECT-033` / `REVIEW-033` / `DOCS-033` + shared `REGRESS-033` / `PKG-033` — [release-gate-0.33.toml](acceptance/release-gate-0.33.toml) · [RELEASE_0_33](acceptance/RELEASE_0_33.md) · [inventory-033](acceptance/production-grade-inventory-033.toml) |
| Web Component platform (RFC-0060; D-064; extends RFC-0021 / 0025) | Accepted ABI plus `ElementStateOwnership`, `InteractionState`, `OptimisticMutation`, `GestureOverlayCatalog`, `ReactMigrationMatrix`, SSR/HTMX lifecycle, rich surfaces, authoring, composition, and stable inventory | [Platform](implementation/WEB_COMPONENT_PLATFORM.md) + [interaction contracts](implementation/WEB_COMPONENT_INTERACTION_CONTRACTS.md) — phases 0.36–0.41; **0.36 Published in-tree** ([#92](https://github.com/eddiethedean/hedron/issues/92)–[#97](https://github.com/eddiethedean/hedron/issues/97)) | [Web Component platform acceptance](acceptance/WEB_COMPONENT_PLATFORM.md) · [RELEASE_0_36](acceptance/RELEASE_0_36.md) · [release-gate-0.36.toml](acceptance/release-gate-0.36.toml) — Verified `ABI-036`…`PKG-036` |
