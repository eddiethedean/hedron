...
| Data-app surface NiceGUI expansions (0033–0036) | Maps, media download/Range, surface chrome, scenario marks | Accepted — phase 0.15 | 0.15 release gate |
...
| Interaction authoring ergonomics (0039) | `region`/`@fragment`, `swap` builders, dev region diagnostics + Explorer click preview | Accepted — phase 0.15 DX | 0.15 release gate |
