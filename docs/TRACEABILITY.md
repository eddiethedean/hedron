...
| Posit Workbench deployment adapter (RFC-0062; D-057) | `hedron-workbench`, pure config/discovery resolver, pre-import launcher, ASGI path normalization, and browser-mount URLs/redirects/cookies | Implemented — phase 0.29 **Published** (`v0.30.0`); composes existing Hedron mount/security contracts; automatic is launch-command-only | [release-gate-0.29.toml](acceptance/release-gate-0.29.toml) |
