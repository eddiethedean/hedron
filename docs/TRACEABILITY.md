...
| Accessibility engineering / inclusive authoring (0051–0055; RFC-0023 umbrella) | `AccessibilityContract` / profile / scenarios / Explorer a11y / PE / landmarks / Page scripts / governance | Published as phase 0.19 (`v0.19.0`); available on the living `0.26.x` train | [release-gate-0.19.toml](acceptance/release-gate-0.19.toml) |
...
| Web Component platform (RFC-0060; extends RFC-0021 / 0025) | Draft ABI plus `ElementStateOwnership`, `InteractionState`, `OptimisticMutation`, `GestureOverlayCatalog`, `ReactMigrationMatrix`, SSR/HTMX lifecycle, rich surfaces, authoring, composition, and stable inventory | [Platform](implementation/WEB_COMPONENT_PLATFORM.md) + [interaction contracts](implementation/WEB_COMPONENT_INTERACTION_CONTRACTS.md) — draft phases 0.33–0.38 | [Web Component platform acceptance](acceptance/WEB_COMPONENT_PLATFORM.md) — draft `STATE-033`, `ACTIONSTATE-034`, `INTERACT-034`, `OPTIMISTIC-035`, `MIGRATE-036`, and later gates |
