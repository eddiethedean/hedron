...
| Production-quality maturity program (RFC-0056; D-053) | Stable-tier expansion, live-transport disposition, production archetype / landmine quarantine; optional undated `1.0` DoD | Planned — phases 0.23–0.25 (0.21/0.22 remain P0 owners) | [release-gate-0.23.toml](acceptance/release-gate-0.23.toml) · [0.24](acceptance/release-gate-0.24.toml) · [0.25](acceptance/release-gate-0.25.toml) |
