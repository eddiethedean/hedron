...
| Web Component platform (RFC-0060; extends RFC-0021 / 0025) | Draft ABI plus `ElementStateOwnership`, `InteractionState`, `OptimisticMutation`, `GestureOverlayCatalog`, `ReactMigrationMatrix`, SSR/HTMX lifecycle, rich surfaces, authoring, composition, and stable inventory | [Platform](implementation/WEB_COMPONENT_PLATFORM.md) + [interaction contracts](implementation/WEB_COMPONENT_INTERACTION_CONTRACTS.md) — draft phases 0.33–0.38 ([#92](https://github.com/eddiethedean/hedron/issues/92)–[#97](https://github.com/eddiethedean/hedron/issues/97)) | [Web Component platform acceptance](acceptance/WEB_COMPONENT_PLATFORM.md) — draft `STATE-033`, `ACTIONSTATE-034`, `INTERACT-034`, `OPTIMISTIC-035`, `MIGRATE-036`, and later gates |
| Streamlit AST migration assistant (RFC-0061; extends RFC-0017 / 0024 / 0026) | `hedron migrate streamlit`, versioned mapping/report schema, source maps, stable findings, secure generated scaffold, and explicit non-parity | Planned phase 0.29 flagship CLI modules; non-executing AST resolver, migration IR/registry, and deterministic generator ([#88](https://github.com/eddiethedean/hedron/issues/88)) | Planned `MIGRATE-029`: no-execution/no-overwrite, no-drop mapping corpus, parity fixtures, security/a11y/perf/adversarial/packaging evidence |
