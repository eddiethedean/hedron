...
| Production-quality maturity program (RFC-0056; D-053) | Stable-tier expansion (**0.23 Published** — locked CRUD facade), live-transport disposition, production archetype / landmine quarantine; optional undated `1.0` DoD | 0.23 Verified; 0.24–0.25 Planned (0.21 human AT sessions remain P0) | [release-gate-0.23.toml](acceptance/release-gate-0.23.toml) · [STABLE_FACADE](api/STABLE_FACADE.md) · [0.24](acceptance/release-gate-0.24.toml) · [0.25](acceptance/release-gate-0.25.toml) |
