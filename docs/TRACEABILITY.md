...
| Production-grade MCP projection (RFC-0065; D-060; extends RFC-0043) | Deny-by-default authenticated Streamable HTTP projection; Supported inventory only; satellite `hedron-mcp` `0.2.0` Beta at cut | Planned phase 0.32 ([#89](https://github.com/eddiethedean/hedron/issues/89)); remains Alpha `0.1.x` today | Planned `PROTOCOL-032`…`PKG-032` — [release-gate-0.32.toml](acceptance/release-gate-0.32.toml) · [RELEASE_0_32](acceptance/RELEASE_0_32.md) · [inventory-032](acceptance/production-grade-inventory-032.toml) |
| Web Component platform (RFC-0060; extends RFC-0021 / 0025) | Draft ABI plus `ElementStateOwnership`, `InteractionState`, `OptimisticMutation`, `GestureOverlayCatalog`, `ReactMigrationMatrix`, SSR/HTMX lifecycle, rich surfaces, authoring, composition, and stable inventory | [Platform](implementation/WEB_COMPONENT_PLATFORM.md) + [interaction contracts](implementation/WEB_COMPONENT_INTERACTION_CONTRACTS.md) — draft phases 0.35–0.40 ([#92](https://github.com/eddiethedean/hedron/issues/92)–[#97](https://github.com/eddiethedean/hedron/issues/97)) | [Web Component platform acceptance](acceptance/WEB_COMPONENT_PLATFORM.md) — draft `STATE-035`, `ACTIONSTATE-036`, `INTERACT-036`, `OPTIMISTIC-037`, `MIGRATE-038`, and later gates |
