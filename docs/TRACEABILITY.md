...
| Accessibility engineering / inclusive authoring (0051–0055; RFC-0023 umbrella) | `AccessibilityContract` / profile / scenarios / Explorer a11y / PE / landmarks / Page scripts / governance | Published as phase 0.19 (`v0.19.0`); living train is `0.23.0` (**Published**) | [release-gate-0.19.toml](acceptance/release-gate-0.19.toml) |
...
| Production-quality maturity program (RFC-0056; D-053) | Stable-tier expansion (**0.23 Published** — locked CRUD facade), live-transport disposition (**0.24 packet refine complete** — cut undecided), production archetype / landmine quarantine; optional undated `1.0` DoD | 0.23 Verified; 0.24–0.25 Planned (0.21 human AT sessions remain P0) | [release-gate-0.23.toml](acceptance/release-gate-0.23.toml) · [STABLE_FACADE](api/STABLE_FACADE.md) · [LIVE_DISPOSITION](api/LIVE_DISPOSITION.md) · [0.24](acceptance/release-gate-0.24.toml) · [0.25](acceptance/release-gate-0.25.toml) |
