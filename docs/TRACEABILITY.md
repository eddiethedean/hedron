...
| Posit Workbench deployment adapter (owning RFC planned) | `hedron-workbench`, pure config/discovery resolver, pre-import launcher, ASGI path normalization, and browser-mount URLs/redirects/cookies | Planned phase 0.29; composes existing Hedron mount/security contracts, defines automatic as launch-command-only adoption, and preserves ordinary ASGI behavior | Planned `CONTRACT-029`, `RESOLVE-029`, `PATH-029`, `URL-029`, `RUNNER-029`, `DX-029`, `SECURITY-029`, `REALWB-029`, compatibility/performance, and package gates |
| Web Component platform (RFC-0060; extends RFC-0021 / 0025) | Draft ABI plus `ElementStateOwnership`, `InteractionState`, `OptimisticMutation`, `GestureOverlayCatalog`, `ReactMigrationMatrix`, SSR/HTMX lifecycle, rich surfaces, authoring, composition, and stable inventory | [Platform](implementation/WEB_COMPONENT_PLATFORM.md) + [interaction contracts](implementation/WEB_COMPONENT_INTERACTION_CONTRACTS.md) — draft phases 0.34–0.39 ([#92](https://github.com/eddiethedean/hedron/issues/92)–[#97](https://github.com/eddiethedean/hedron/issues/97)) | [Web Component platform acceptance](acceptance/WEB_COMPONENT_PLATFORM.md) — draft `STATE-034`, `ACTIONSTATE-035`, `INTERACT-035`, `OPTIMISTIC-036`, `MIGRATE-037`, and later gates |
| Streamlit AST migration assistant (RFC-0061; extends RFC-0017 / 0024 / 0026) | `hedron migrate streamlit`, versioned mapping/report schema, source maps, stable findings, secure generated scaffold, and explicit non-parity | Planned phase 0.30 flagship CLI modules; non-executing AST resolver, migration IR/registry, and deterministic generator ([#88](https://github.com/eddiethedean/hedron/issues/88)) | Planned `MIGRATE-030`: no-execution/no-overwrite, no-drop mapping corpus, parity fixtures, security/a11y/perf/adversarial/packaging evidence |
