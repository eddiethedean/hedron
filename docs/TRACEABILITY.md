...
| Accessibility engineering / inclusive authoring (0051–0055; RFC-0023 umbrella) | `AccessibilityContract` / profile / scenarios / Explorer a11y / PE / landmarks / Page scripts / governance | Published as phase 0.19 (`v0.19.0`); living train is `0.22.0` (**Published**) | [release-gate-0.19.toml](acceptance/release-gate-0.19.toml) |
...
| Production-quality maturity program (RFC-0056; D-053) | Stable-tier expansion (0.23 packet refine complete — locked CRUD facade), live-transport disposition, production archetype / landmine quarantine; optional undated `1.0` DoD | Planned — phases 0.23–0.25 (0.21 human AT sessions remain P0) | [release-gate-0.23.toml](acceptance/release-gate-0.23.toml) · [STABLE_FACADE](api/STABLE_FACADE.md) · [0.24](acceptance/release-gate-0.24.toml) · [0.25](acceptance/release-gate-0.25.toml) |
