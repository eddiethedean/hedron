...
| Accessibility engineering / inclusive authoring (0051–0055; RFC-0023 umbrella) | `AccessibilityContract` / profile / scenarios / Explorer a11y / PE / landmarks / Page scripts / governance | Implemented — phase 0.19 **Ready to cut** on `main` (`0.19.0`; last published PyPI/git = `v0.18.0`) | [release-gate-0.19.toml](acceptance/release-gate-0.19.toml) |
