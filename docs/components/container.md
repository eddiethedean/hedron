...
<section class="hedron-component-demo" data-hedron-component-demo="Container"><div class="hdc-stage"><div class="hdc-container"><h3>Profile</h3><p>This readable block stays centered with a bounded width.</p></div></div></section>
...
component = Container(Heading('Profile', level=1), Text('Manage your public details.'))
```
...
|---|---|---|
| `children` | `NodeLike` | Content inside the width constraint. |
| `class_` | `str | None` | Override the default `hedron-container` class. |
