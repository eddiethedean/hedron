---
title: Logo
description: Application logo image with required alt text.
---
...
| | |
|---|---|
| Import | `from hedron import Logo` |
| Distribution | `hedron` |
| Backend activity | No |
...
<section class="hedron-component-demo" data-hedron-component-demo="Logo"><div class="hdc-stage"><div class="hdc-result"><strong>Logo</strong><span>Application logo image with required alt text.</span></div></div></section>
...
Keep `Logo` at the smallest semantic boundary. Fragment routes should return only
the replaced region and preserve stable target IDs across success, validation, empty,
loading, and error responses.

`Logo` is primarily presentational; keep any mutation on an explicit action or component route.
