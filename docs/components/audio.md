---
title: Audio
description: Accessible HTML audio player with SafeUrl source.
---
...
| | |
|---|---|
| Import | `from hedron import Audio` |
| Distribution | `hedron` |
| Backend activity | No |
...
```text
Audio(src: 'SafeUrl | str', *, tracks: 'Sequence[Mapping[str, object] | NodeLike]' = (), controls: 'bool' = True, autoplay: 'bool' = False, loop: 'bool' = False, muted: 'bool' = False, preload: 'str | None' = None, allow_external: 'bool' = False, class_: 'str | None' = None, mark: 'str | None' = None, **kwargs: 'object') -> 'None'
```
...
Keep `Audio` at the smallest semantic boundary. Fragment routes should return only
the replaced region and preserve stable target IDs across success, validation, empty,
loading, and error responses.

`Audio` is primarily presentational; keep any mutation on an explicit action or component route.
