---
title: DateTimeInput
description: Native datetime-local input.
---
...
| | |
|---|---|
| Import | `from hedron import DateTimeInput` |
| Distribution | `hedron` |
| Backend activity | No |
...
```python
from hedron import DateTimeInput

component = DateTimeInput('starts')
```
...
```python
DateTimeInput(name: 'str', *, id: 'str | None' = None, value: 'str' = '', min: 'str | None' = None, max: 'str | None' = None, step: 'float | int | str | None' = None, required: 'bool' = False, disabled: 'bool' = False, mark: 'str | None' = None, aria_describedby: 'str | None' = None, aria_invalid: 'str | None' = None, aria_required: 'str | None' = None, **kwargs: 'object') -> 'None'
```
...
Keep `DateTimeInput` at the smallest semantic boundary. Fragment routes should return only
the replaced region and preserve stable target IDs across success, validation, empty,
loading, and error responses.

`DateTimeInput` participates in interaction markup. Pair it with an explicit `@action` / `@component` POST (and CSRF) when the control mutates state.
