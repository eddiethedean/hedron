...
```python
from hedron import ComponentRef, Lazy, Skeleton
component = Lazy(ref=ComponentRef('activity-feed', '/activity-feed'), placeholder=Skeleton(lines=3), target_id='activity-feed')
```
