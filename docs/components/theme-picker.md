...
```text
ThemePicker(*, themes: 'tuple[str, ...]' = ('folio', 'classic', 'aurora'), color_modes: 'tuple[ColorMode, ...]' = ('system', 'light', 'dark'), selected: 'ThemePreference | None' = None, action: 'SafeUrl | str' = '/preferences/theme', csrf_token: 'str | None' = None, compact: 'bool' = False, id: 'str | None' = None, class_: 'str | None' = None, mark: 'str | None' = None, **kwargs: 'object') -> 'None'
```
