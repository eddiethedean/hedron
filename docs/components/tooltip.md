---
title: Tooltip
description: Accessible tooltip / title help.
---
...
| | |
|---|---|
| Import | `from hedron import Tooltip` |
| Distribution | `hedron` |
| Backend activity | No |
...
```python
from hedron import Text, Tooltip
component = Tooltip('More info', Text('Hover'))
```
...
```text
Tooltip(text: 'str', *nodes: 'NodeLike', children: 'NodeLike' = None, id: 'str | None' = None, class_: 'str | None' = None, mark: 'str | None' = None, **kwargs: 'object') -> 'None'
```
...
Keep `Tooltip` at the smallest semantic boundary. Fragment routes should return only
the replaced region and preserve stable target IDs across success, validation, empty,
loading, and error responses.

`Tooltip` is primarily presentational; keep any mutation on an explicit action or component route.
