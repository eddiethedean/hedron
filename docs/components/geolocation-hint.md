---
title: GeolocationHint
description: Static reminder that geolocation is spoofable.
---
...
| | |
|---|---|
| Import | `from hedron import GeolocationHint` |
| Distribution | `hedron` |
| Backend activity | No |
...
<section class="hedron-component-demo" data-hedron-component-demo="GeolocationHint"><div class="hdc-stage"><div class="hdc-result"><strong>GeolocationHint</strong><span>Static reminder that geolocation is spoofable.</span></div></div></section>
...
```python
from hedron import GeolocationHint

component = GeolocationHint()
```
...
Keep `GeolocationHint` at the smallest semantic boundary. Fragment routes should return only
the replaced region and preserve stable target IDs across success, validation, empty,
loading, and error responses.

`GeolocationHint` is primarily presentational; keep any mutation on an explicit action or component route.
