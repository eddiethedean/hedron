---
title: ToggleSwitch
description: Switch-styled checkbox control.
---
...
| | |
|---|---|
| Import | `from hedron import ToggleSwitch` |
| Distribution | `hedron` |
| Backend activity | No |
...
Keep `ToggleSwitch` at the smallest semantic boundary. Fragment routes should return only
