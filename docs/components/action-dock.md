---
title: ActionDock
description: Sticky action dock for primary controls.
---
...
| | |
|---|---|
| Import | `from hedron import ActionDock` |
| Distribution | `hedron` |
| Backend activity | No |
...
<section class="hedron-component-demo" data-hedron-component-demo="ActionDock"><div class="hdc-stage"><div class="hdc-result"><strong>ActionDock</strong><span>Sticky action dock for primary controls.</span></div></div></section>
...
```python
from hedron import ActionDock, Button

component = ActionDock(Button('Save'))
```
...
| `placement` | `Literal['bottom', 'aside']` | Layout placement for the dock. Default: `'bottom'`. |
...
Keep `ActionDock` at the smallest semantic boundary. Fragment routes should return only
the replaced region and preserve stable target IDs across success, validation, empty,
loading, and error responses.

`ActionDock` is primarily presentational; keep any mutation on an explicit action or component route.
