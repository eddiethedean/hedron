...
```text
Help(text: 'str', *, id: 'str | None' = None, for_: 'str | None' = None, class_: 'str | None' = None, mark: 'str | None' = None, **kwargs: 'object') -> 'None'
```
...
`Help` is primarily presentational; keep any mutation on an explicit action or component route.
