---
title: Gallery
description: Responsive image/video gallery with optional lightbox mode.
---
...
| | |
|---|---|
| Import | `from hedron import Gallery` |
| Distribution | `hedron` |
| Backend activity | No |
...
<section class="hedron-component-demo" data-hedron-component-demo="Gallery"><div class="hdc-stage"><div class="hdc-result"><strong>Gallery</strong><span>Responsive image/video gallery with optional lightbox mode.</span></div></div></section>
...
Keep `Gallery` at the smallest semantic boundary. Fragment routes should return only
the replaced region and preserve stable target IDs across success, validation, empty,
loading, and error responses.

`Gallery` is primarily presentational; keep any mutation on an explicit action or component route.
