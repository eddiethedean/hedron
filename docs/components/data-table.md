...
<section class="hedron-component-demo" data-hedron-component-demo="DataTable"><div class="hdc-stage"><label class="hdc-filter">Filter employees<input type="search" data-hdc-filter></label><table><caption>Employees</caption><thead><tr><th>Name</th><th>Team</th><th>Status</th></tr></thead><tbody data-hdc-rows><tr><td>Ada</td><td>Platform</td><td>Active</td></tr><tr><td>Grace</td><td>Compiler</td><td>Active</td></tr><tr><td>Alan</td><td>Research</td><td>Leave</td></tr></tbody></table><p role="status" data-hdc-status>Showing 3 employees.</p></div></section>
