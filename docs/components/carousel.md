---
title: Carousel
description: No-JS carousel as an ordered slide list with controls.
---
...
| | |
|---|---|
| Import | `from hedron import Carousel` |
| Distribution | `hedron` |
| Backend activity | No |
...
```python
from hedron import Carousel, Text
component = Carousel([Text('One'), Text('Two')])
```
...
```text
Carousel(slides: 'Sequence[tuple[str, NodeLike] | NodeLike]', *, id: 'str | None' = None, label: 'str' = 'Carousel', class_: 'str | None' = None, mark: 'str | None' = None, **kwargs: 'object') -> 'None'
```
...
Keep `Carousel` at the smallest semantic boundary. Fragment routes should return only
the replaced region and preserve stable target IDs across success, validation, empty,
loading, and error responses.

`Carousel` is primarily presentational; keep any mutation on an explicit action or component route.
