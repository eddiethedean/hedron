...
| | |
|---|---|
| Import | `from hedron import TimeInput` |
| Distribution | `hedron` |
| Backend activity | No |
...
```python
from hedron import TimeInput

component = TimeInput('at')
```
...
```python
TimeInput(name: 'str', *, id: 'str | None' = None, value: 'str' = '', min: 'str | None' = None, max: 'str | None' = None, step: 'float | int | str | None' = None, required: 'bool' = False, disabled: 'bool' = False, mark: 'str | None' = None, aria_describedby: 'str | None' = None, aria_invalid: 'str | None' = None, aria_required: 'str | None' = None, **kwargs: 'object') -> 'None'
```
...
Keep `TimeInput` at the smallest semantic boundary. Fragment routes should return only
the replaced region and preserve stable target IDs across success, validation, empty,
loading, and error responses.

`TimeInput` participates in interaction markup. Pair it with an explicit `@action` / `@component` POST (and CSRF) when the control mutates state.
