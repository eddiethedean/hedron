...
!!! note "PyPI vs `main`"
    ...
    Until `v0.19.0` is tagged, PyPI still serves **`v0.18.0`**. The Dev Container / Codespaces
    path uses this repo’s `main` workspace, so you get Ready-to-cut `0.19.0` without waiting
    for the tag.
