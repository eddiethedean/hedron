...
compose. Outside the workspace, install `hedron[charts]>=0.50.0,<0.51` for the compatible
chart satellite; see
...
| DataEditor / Auto / charts | dashboard + `/charts/*` (`hedron[charts]>=0.50.0,<0.51` or the monorepo source) | Chart panel refresh (sim) |
