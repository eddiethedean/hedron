...
compose. Outside the workspace, install `hedron[charts]>=0.58.0,<0.60` from PyPI
...
| DataEditor / Auto / charts | dashboard + `/charts/*` (`hedron[charts]>=0.58.0,<0.60` or the monorepo source) | Chart panel refresh (sim) |
