...
compose. Outside the workspace, install `hedron[charts]>=0.61.0,<0.62` from PyPI
...
| DataEditor / Auto / charts | dashboard + `/charts/*` (`hedron[charts]>=0.61.0,<0.62` or the monorepo source) | Chart panel refresh (sim) |
