...
compose. Outside the workspace, install `hedron[charts]>=0.55.0,<0.56` from PyPI while
...
| DataEditor / Auto / charts | dashboard + `/charts/*` (`hedron[charts]>=0.55.0,<0.56` or the monorepo source) | Chart panel refresh (sim) |
