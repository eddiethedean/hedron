...
compose. Outside the workspace, install `hedron[charts]>=1.0.1,<1.1` from PyPI (see
...
| DataEditor / Auto / charts | dashboard + `/charts/*` (`hedron[charts]>=1.0.1,<1.1` or the monorepo source) | Chart panel refresh (sim) |
