...
- how a component page becomes a complete HTML document;
...
| 3 | A validated note form | A valid POST saves a note; an invalid or missing-CSRF request fails safely | [Minimal form POST](../guides/minimal-form.md) |
...
```text
component page → refreshable view → HTML fragment → validated form POST
```
