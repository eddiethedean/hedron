...
`docs/archive/`. The current repository release is `v0.60.2`, published on PyPI.
...
3. `docs/acceptance/release-gate-0.60.toml` is Verified with zero Deferred gates and
   `scripts/verify_pkg_60.py` passes for the candidate. Historical packets `scripts/verify_pkg_59.py`,
