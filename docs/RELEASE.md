...
This is the maintainer runbook for the `0.64.x` train. Historical cut records live under
`docs/archive/`. The current repository train is `v0.64.0`; the latest public PyPI release is
`v0.63.0` until the 0.64 upload is completed.
...
3. `docs/acceptance/release-gate-0.64.toml` must be Verified with zero Deferred gates and
