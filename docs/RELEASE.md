...
3. `docs/acceptance/release-gate-0.59.toml` is Verified with zero Deferred gates and
...
bash scripts/ci_checks.sh evidence --python 3.12 --gate-version 0.59.0
bash scripts/ci_checks.sh browser --python 3.12
uv run python scripts/check_release_gate.py 0.59.0
