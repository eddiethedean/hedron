...
live under `docs/archive/`. The published tip is `v0.58.0`; PyPI serves `hedron`
`0.58.0` (`registry_status = uploaded`).
...
6. Keep `registry_status = "uploaded"`, `pypi_version = "0.58.0"`, and application
   install pins aligned with the published version.
