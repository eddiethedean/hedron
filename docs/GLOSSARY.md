...
**Pin** — An install constraint with an upper bound, for example `hedron>=0.48.0,<0.49`.
...
**Published** — A cut that is on the current train (`v0.48.0` in-tree; PyPI still `0.46.0`). Pin the matching
