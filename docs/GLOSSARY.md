...
**Pin** — An install constraint with an upper bound, for example `hedron>=0.60.0,<0.61`.
...
**Published** — A cut available on the current train (`v0.60.0` in-tree and on PyPI). Pin the matching
