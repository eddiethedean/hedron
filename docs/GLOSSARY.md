...
**Pin** — An install constraint with an upper bound, for example `hedron>=0.58.0,<0.60`.
...
**Published** — A cut available on the current train (`v0.59.0` in-tree; `v0.58.0` on PyPI). Pin the matching
