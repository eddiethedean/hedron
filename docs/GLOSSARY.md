...
**Pin** — An install constraint with an upper bound, for example `hedron>=0.49.0,<0.50`.
...
**Published** — A cut that is on the current train (`v0.49.0` in-tree; PyPI still `0.47.0`). Pin the matching
