...
**Pin** — An install constraint with an upper bound, for example `hedron>=0.46.0,<0.47`.
...
**Published** — A cut that is on the current train (`v0.46.0` on PyPI). Pin the matching
