...
Adapters may support memory, Pandas, Polars, PyArrow, SQLAlchemy, SQLModel, Django QuerySets, or application services. Narwhals is the initial optional normalization layer for dataframe-like inputs. Lazy sources must not be collected implicitly.
