...
| [0078](RFC-0078-CURATED-EXTRAS-LIFECYCLE.md) | Curated extras depth and lifecycle closure | Accepted (D-087; Stage 0 refined by D-088; [#507](https://github.com/eddiethedean/hedron/issues/507); companion [#504](https://github.com/eddiethedean/hedron/issues/504)–[#506](https://github.com/eddiethedean/hedron/issues/506); no runtime) |
