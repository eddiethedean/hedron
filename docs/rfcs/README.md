...
| [0094](RFC-0094-EDRON-AUTHORING-FACADE.md) | Edron batteries-included Pythonic authoring facade | Accepted and implemented; Edron `0.9.1` verified in-tree, publication pending |
