...
| [0094](RFC-0094-EDRON-AUTHORING-FACADE.md) | Edron batteries-included Pythonic authoring facade | Draft; phase unassigned; Decision A blocked in the [Edron 0.1 acceptance packet](../acceptance/EDRON_001.md) |
