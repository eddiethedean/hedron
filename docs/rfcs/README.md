...
| [0078](RFC-0078-CURATED-EXTRAS-LIFECYCLE.md) | Curated extras depth and lifecycle closure | Accepted (D-087; D-088; Stage 1 `v0.51.0` on PyPI; [#507](https://github.com/eddiethedean/hedron/issues/507); companion [#504](https://github.com/eddiethedean/hedron/issues/504)–[#506](https://github.com/eddiethedean/hedron/issues/506)) |
