...
| [0033](RFC-0033-MAP-GEOJSON.md) | Map and GeoJSON presentation | Draft |
| [0034](RFC-0034-MEDIA-DOWNLOAD-RANGE.md) | Authenticated downloads and ranged media delivery | Draft |
| [0035](RFC-0035-SURFACE-CHROME.md) | Surface chrome — carousel, timeline, context menu, chips, progress | Draft |
| [0036](RFC-0036-SCENARIO-MARKS.md) | AppScenario identity marks and filter asserts | Draft |
...
| [0039](RFC-0039-INTERACTION-ERGONOMICS.md) | Interaction authoring ergonomics (`region`, `swap`, diagnostics) | Draft |
