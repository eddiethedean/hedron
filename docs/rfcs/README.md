...
| [0094](RFC-0094-EDRON-AUTHORING-FACADE.md) | Edron batteries-included Pythonic authoring facade | Accepted, implemented, and published as Edron `1.0.0` on Hedron 1.x |
...
| [0096](RFC-0096-HEDRON-1.0-INTERFACE-CONSOLIDATION.md) | Hedron 1.0 interface and HTMX/Alpine/component-engine consolidation | Accepted, implemented, verified, and published as `v1.0.0`; D-114–D-117 |
