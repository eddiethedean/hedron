...
The repository source targets living Hedron train `0.64.x` (in-tree tip and PyPI release `v0.64.0`;
PyPI consumers use `hedron-core>=0.64.0,<0.65` ). Reference / demo
