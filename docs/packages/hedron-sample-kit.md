...
The repository source targets living Hedron train `0.62.x` (in-tree tip and PyPI release `v0.62.0`;
PyPI consumers use `hedron-core>=0.62.0,<0.63` ). Reference / demo
