...
The repository source targets living Hedron train `0.60.x` (in-tree tip `v0.60.0`; PyPI `v0.59.0` until upload;
PyPI consumers use `hedron-core>=0.60.0,<0.61` ). Reference / demo
