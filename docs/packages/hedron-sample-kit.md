...
The repository source targets living Hedron train `0.63.x` (in-tree tip and PyPI release `v0.63.0`;
PyPI consumers use `hedron-core>=0.63.0,<0.64` ). Reference / demo
