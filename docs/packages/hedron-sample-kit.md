...
The repository source targets living Hedron train `0.61.x` (in-tree tip and PyPI release `v0.61.0`;
PyPI consumers use `hedron-core>=0.61.0,<0.62` ). Reference / demo
