...
The repository source is compatible with `hedron-core>=0.28.0,<0.29`. Reference / demo
...
Versions through `0.1.5` target older Hedron cores; keep the `>=0.1.8` floor. Details:
