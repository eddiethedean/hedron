...
**Package maturity:** Beta · **Published version:** `v1.0.1`
...
```bash
pip install "hedron[conformance]>=1.0.1,<1.1"
# or
pip install "hedron-conformance>=1.0.1,<1.1"
```

Checkout tip `v1.0.1` uses `uv sync`; applications install `>=1.0.1,<1.1` from PyPI.
