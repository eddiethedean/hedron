...
**Package maturity:** Beta (`0.52.x`) · extra `hedron[posit]` · pin `>=0.52.0,<0.53` (PyPI still `>=0.51.0,<0.52` while deferred)
...
0.52 train (`HedronWorkbench` subclass; no 0.33 deprecation warning).
