...
**Package maturity:** Beta (`0.60.x`, `v0.60.0` in-tree; PyPI `v0.59.0` until upload) · extra `hedron[posit]` · pin `>=0.60.0,<0.61`
...
0.60 train (`HedronWorkbench` subclass; no 0.33 deprecation warning).
