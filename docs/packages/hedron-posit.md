...
**Package maturity:** Beta (`0.62.x`, `v0.62.0` in-tree and on PyPI) · extra `hedron[posit]` · pin `>=0.62.0,<0.63`
...
0.62 train (`HedronWorkbench` subclass; no 0.33 deprecation warning).
