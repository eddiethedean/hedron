...
**Package maturity:** Beta (`0.56.x`) · extra `hedron[posit]` · pin `>=0.56.0,<0.57` in-tree (PyPI `>=0.54.0,<0.55` while deferred)
...
0.56 train (`HedronWorkbench` subclass; no 0.33 deprecation warning).
