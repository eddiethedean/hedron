...
**Package maturity:** Beta (`0.54.x`) · extra `hedron[posit]` · pin `>=0.54.0,<0.55` (PyPI still `>=0.52.0,<0.53` while deferred)
...
0.53 train (`HedronWorkbench` subclass; no 0.33 deprecation warning).
