...
**Package maturity:** Beta (`0.57.x`) · extra `hedron[posit]` · pin `>=0.57.0,<0.58` in-tree (PyPI `>=0.56.0,<0.58` )
...
0.57 train (`HedronWorkbench` subclass; no 0.33 deprecation warning).
