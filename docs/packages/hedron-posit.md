...
**Package maturity:** Beta (`0.58.x`) · extra `hedron[posit]` · pin `>=0.58.0,<0.59` in-tree (PyPI `>=0.56.0,<0.59` )
...
0.58 train (`HedronWorkbench` subclass; no 0.33 deprecation warning).
