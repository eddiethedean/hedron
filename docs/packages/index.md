...
| [hedron-charts](hedron-charts.md) | `hedron[charts]` | First-party charts and visualization adapters; `>=0.2.1,<0.3` on the 0.63 train |
...
Checkout tip and latest PyPI release are `v0.63.0`; applications install `>=0.63.0,<0.64` from PyPI.
