...
```bash
pip install "hedron[data,dev,posit]>=0.56.0,<0.57"
```

Checkout tip is `v0.56.0` (`>=0.56.0,<0.57` in-tree); PyPI first-run stays `>=0.56.0,<0.57` until the Git tag / PyPI upload lands.
