...
Living Hedron train `0.64.x` (checkout tip `v0.64.0`; flagship extra install from PyPI
stays `>=0.64.0,<0.65` ). **Not** a Supported production server. The
...
```bash
pip install "hedron[notebook]>=0.64.0,<0.65"
# or
