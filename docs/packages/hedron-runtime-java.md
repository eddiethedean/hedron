...
**Version:** `0.31.0` · **Runtime matrix:** JDK 11 / 17 / 21 (`--release 11` bytecode)  
**Coordinates:** `io.hedron:hedron-runtime-java:0.31.0`
...
java -jar target/hedron-runtime-java-0.31.0.jar path/to/portable_v1.json
```
