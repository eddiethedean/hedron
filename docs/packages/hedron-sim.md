...
Compatible with living Hedron train `0.52.x` (checkout tip `v0.52.0`; PyPI still
`>=0.51.0,<0.52` while deferred). Author demos with ordinary Hedron components, then
