...
The source tree requires `hedron-core>=1.0.0,<2.0`; applications installed from PyPI
should pin the flagship extra to `hedron[mcp]>=1.0.0,<1.1`. Disabled and empty until resources and tools are
