...
Living Hedron train `0.62.x` (checkout tip `v0.62.0`; flagship extra install from PyPI
stays `>=0.62.0,<0.63` ). Disabled and empty until resources and tools are
...
```bash
pip install "hedron[mcp]>=0.62.0,<0.63"
# or
