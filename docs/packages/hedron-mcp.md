...
Living Hedron train `0.56.x` (checkout tip `v0.56.1`; flagship extra install from PyPI
stays `>=0.56.0,<0.58` ). Disabled and empty until resources and tools are
...
```bash
pip install "hedron[mcp]>=0.56.0,<0.58"
# or
