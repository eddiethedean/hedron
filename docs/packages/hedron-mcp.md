...
Living Hedron train `0.63.x` (checkout tip `v0.63.0`; flagship extra install from PyPI
stays `>=0.63.0,<0.64` ). Disabled and empty until resources and tools are
...
```bash
pip install "hedron[mcp]>=0.63.0,<0.64"
# or
