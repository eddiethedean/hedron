...
Living Hedron train `0.56.x` (checkout tip `v0.57.0`; flagship extra install from PyPI
stays `>=0.56.0,<0.59` ). Disabled and empty until resources and tools are
...
```bash
pip install "hedron[mcp]>=0.56.0,<0.59"
# or
