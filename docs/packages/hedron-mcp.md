...
Living Hedron train `0.60.x` (checkout tip `v0.60.2`; flagship extra install from PyPI
stays `>=0.60.2,<0.61` ). Disabled and empty until resources and tools are
...
```bash
pip install "hedron[mcp]>=0.60.2,<0.61"
# or
