...
<div class="hedron-eyebrow">Python · FastAPI · HTMX · last published v0.28.1</div>
...
**Refresh status**. Pin `hedron>=0.28.1,<0.29`. Before production, see
...
Hedron **0.28.x** is published (last `v0.28.1`; Beta packages — pin `hedron>=0.28.1,<0.29`).
