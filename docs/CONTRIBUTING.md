...
| `evidence` | Evidence bundle, dep audit, release-gate check for current train, `verify_pkg_15.py` | **Yes** (every PR / push) |
| `release` | Packaging rehearsal (`verify_pkg_15`) | After `evidence` succeeds |
