...
| `evidence` | `evidence` — Evidence bundle, dep audit, release-gate check for current train, `verify_pkg_21.py` | **Yes** (every PR / push); also on release |
| `release` (commit CI) | `packaging` — Packaging rehearsal (`verify_pkg_21`) | After `evidence` succeeds |
