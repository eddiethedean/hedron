...
**Stage 1 Implemented** (verified `v1.0.0` repository candidate; PyPI publication
pending). Stage 1
...
Public Stage 1 surface (Verified gates; introduced in published `v0.53.0`; current train `v1.0.0`):
