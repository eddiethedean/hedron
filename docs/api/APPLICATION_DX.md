...
**Stage 1 Implemented** (living tip `v0.63.0`, in-tree and on PyPI). Stage 1
...
Public Stage 1 surface (Verified gates; introduced in published `v0.53.0`; current train `v0.63.0`):
