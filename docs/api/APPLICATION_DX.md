...
**Stage 1 Implemented** (verified in the untagged `v1.0.0` candidate). Stage 1
...
Public Stage 1 surface (Verified gates; introduced in published `v0.53.0`; current candidate train `v1.0.0`):
