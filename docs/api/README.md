...
These surfaces first shipped in the 0.19 phase and remain on the living **0.40.x**
...
- [Accessibility (`hedron_core.a11y`)](A11Y.md) — introduced in 0.19; available on the living 0.40 train
- [Plugins](PLUGINS.md)
- [Testing](TESTING.md)
...
- [Stability classifications](STABILITY.md) — compatibility catalog (current train 0.40.x)
...
- Accessibility engineering (`hedron_core.a11y`, Explorer `/a11y`, PE / landmarks /
  `Page(scripts=)`, automated `AT-019`) shipped on **0.19**; living train **0.40.x**
  (**Published**; last **v0.40.0**) — [A11Y API](A11Y.md),
...
- Native Flask/Django depth, QuerySet DataSource, forms bridge, HDJ manifests/CSP inventory
  (introduced in 0.11; Supported on **0.39.x**)
