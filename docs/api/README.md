...
- [Accessibility (`hedron_core.a11y`)](A11Y.md) — introduced in 0.19; available on the living 0.30 train
- [Plugins](PLUGINS.md)
- [Testing](TESTING.md)
...
- [Stability classifications](STABILITY.md) — compatibility catalog (current train 0.30)
...
- Accessibility engineering (`hedron_core.a11y`, Explorer `/a11y`, PE / landmarks /
  `Page(scripts=)`, automated `AT-019`) shipped on **0.19**; living train **0.30**
