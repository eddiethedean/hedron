...
These surfaces first shipped in the 0.19 phase and remain on the living **0.34.x**
...
- [Stability classifications](STABILITY.md) — compatibility catalog (current train 0.34.x)
...
- Accessibility engineering (`hedron_core.a11y`, Explorer `/a11y`, PE / landmarks /
  `Page(scripts=)`, automated `AT-019`) shipped on **0.19**; living train **0.34.x**
  (**Published**; last **v0.34.0**) — [A11Y API](A11Y.md),
