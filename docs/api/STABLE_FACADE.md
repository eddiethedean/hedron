...
!!! note "Facade inventory from 0.23; living train is 0.52.x"
    ...
    compatibility-protected **`stable`** on the living **0.52** train. Pin
    `hedron>=0.52.0,<0.53` from checkout (PyPI still `>=0.51.0,<0.52` while deferred).
