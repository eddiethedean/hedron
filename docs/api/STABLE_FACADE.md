...
!!! note "Facade inventory from 0.23; living train is 0.54.x"
    ...
    compatibility-protected **`stable`** on the living **0.54** train. Pin
    `hedron>=0.53.0,<0.54` from checkout (PyPI still `>=0.52.0,<0.53` while deferred).
