...
The repository contains the verified, untagged `v1.0.0` candidate; the public PyPI release
remains on the fallback train until publication. The deployment lifecycle symbols below are
