...
**Status:** Published `1.1.0` Stable release<br>
**Target:** Edron `1.1.x`; Hedron `>=1.0.0`<br>
...
Shortcut: pip install "edron[plotly]>=1.0.0"
uv:       uv add "plotly>=5.18,<7"
Shortcut: uv add "edron[plotly]>=1.0.0"
