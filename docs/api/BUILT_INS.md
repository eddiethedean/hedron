...
**Status:** Accepted · current verified candidate train **1.0.x** (publication deferred)
...
index tracks the living **0.41** built-in catalog — do not treat older phase lists as the
complete API.
