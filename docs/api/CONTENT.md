...
```bash
pip install "hedron[markdown]>=0.23.0,<0.24"
```
...
```bash
pip install "hedron[code]>=0.23.0,<0.24"
```
...
```bash
pip install "hedron[images]>=0.23.0,<0.24"
```
...
```bash
pip install "hedron[email]>=0.23.0,<0.24"
```
...
| API | Extra |
|---|---|
| `Markdown` | `pip install "hedron[markdown]>=0.23.0,<0.24"` |
| `highlight_code` | `pip install "hedron[code]>=0.23.0,<0.24"` |
| `process_image` | `pip install "hedron[images]>=0.23.0,<0.24"` |
| `validate_email_address` | `pip install "hedron[email]>=0.23.0,<0.24"` |
| `TrustedHtml.nh3` | `pip install "hedron[sanitize]>=0.23.0,<0.24"` |
