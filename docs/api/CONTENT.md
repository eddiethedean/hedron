...
```bash
pip install "hedron[markdown]>=0.34.0,<0.35"
```
...
```bash
pip install "hedron[code]>=0.34.0,<0.35"
```
...
```bash
pip install "hedron[images]>=0.34.0,<0.35"
```
...
```bash
pip install "hedron[email]>=0.34.0,<0.35"
```
...
| API | Extra |
|---|---|
| `Markdown` | `pip install "hedron[markdown]>=0.34.0,<0.35"` |
| `highlight_code` | `pip install "hedron[code]>=0.34.0,<0.35"` |
| `process_image` | `pip install "hedron[images]>=0.34.0,<0.35"` |
| `validate_email_address` | `pip install "hedron[email]>=0.34.0,<0.35"` |
| `TrustedHtml.nh3` | `pip install "hedron[sanitize]>=0.34.0,<0.35"` |
