...
```bash
pip install "hedron[markdown]>=0.48.0,<0.49"
```
...
```bash
pip install "hedron[code]>=0.48.0,<0.49"
```
...
```bash
pip install "hedron[images]>=0.48.0,<0.49"
```
...
```bash
pip install "hedron[email]>=0.48.0,<0.49"
```
...
| API | Extra |
|---|---|
| `Markdown` | `pip install "hedron[markdown]>=0.48.0,<0.49"` |
| `highlight_code` | `pip install "hedron[code]>=0.48.0,<0.49"` |
| `process_image` | `pip install "hedron[images]>=0.48.0,<0.49"` |
| `validate_email_address` | `pip install "hedron[email]>=0.48.0,<0.49"` |
| `TrustedHtml.nh3` | `pip install "hedron[sanitize]>=0.48.0,<0.49"` |
