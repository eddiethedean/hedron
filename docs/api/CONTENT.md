...
```bash
pip install "hedron[markdown]>=0.44.0,<0.45"
```
...
```bash
pip install "hedron[code]>=0.44.0,<0.45"
```
...
```bash
pip install "hedron[images]>=0.44.0,<0.45"
```
...
```bash
pip install "hedron[email]>=0.44.0,<0.45"
```
...
| API | Extra |
|---|---|
| `Markdown` | `pip install "hedron[markdown]>=0.44.0,<0.45"` |
| `highlight_code` | `pip install "hedron[code]>=0.44.0,<0.45"` |
| `process_image` | `pip install "hedron[images]>=0.44.0,<0.45"` |
| `validate_email_address` | `pip install "hedron[email]>=0.44.0,<0.45"` |
| `TrustedHtml.nh3` | `pip install "hedron[sanitize]>=0.44.0,<0.45"` |
