...
```bash
pip install "hedron[code]>=0.33.0,<0.34"
```
...
```bash
pip install "hedron[images]>=0.33.0,<0.34"
```
...
```bash
pip install "hedron[email]>=0.33.0,<0.34"
```
...
| API | Extra |
|---|---|
| `Markdown` | `pip install "hedron[markdown]>=0.33.0,<0.34"` |
| `highlight_code` | `pip install "hedron[code]>=0.33.0,<0.34"` |
| `process_image` | `pip install "hedron[images]>=0.33.0,<0.34"` |
| `validate_email_address` | `pip install "hedron[email]>=0.33.0,<0.34"` |
| `TrustedHtml.nh3` | `pip install "hedron[sanitize]>=0.33.0,<0.34"` |
