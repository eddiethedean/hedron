...
```bash
pip install "hedron[markdown]>=0.47.0,<0.48"
```
...
```bash
pip install "hedron[code]>=0.47.0,<0.48"
```
...
```bash
pip install "hedron[images]>=0.47.0,<0.48"
```
...
```bash
pip install "hedron[email]>=0.47.0,<0.48"
```
...
| API | Extra |
|---|---|
| `Markdown` | `pip install "hedron[markdown]>=0.47.0,<0.48"` |
| `highlight_code` | `pip install "hedron[code]>=0.47.0,<0.48"` |
| `process_image` | `pip install "hedron[images]>=0.47.0,<0.48"` |
| `validate_email_address` | `pip install "hedron[email]>=0.47.0,<0.48"` |
| `TrustedHtml.nh3` | `pip install "hedron[sanitize]>=0.47.0,<0.48"` |
