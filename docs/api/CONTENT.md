...
```bash
pip install "hedron[markdown]>=0.61.0,<0.62"
```
...
```bash
pip install "hedron[code]>=0.61.0,<0.62"
```
...
```bash
pip install "hedron[images]>=0.61.0,<0.62"
```
...
```bash
pip install "hedron[email]>=0.61.0,<0.62"
```
...
| API | Extra |
|---|---|
| `Markdown` | `pip install "hedron[markdown]>=0.61.0,<0.62"` |
| `highlight_code` | `pip install "hedron[code]>=0.61.0,<0.62"` |
| `process_image` | `pip install "hedron[images]>=0.61.0,<0.62"` |
| `validate_email_address` | `pip install "hedron[email]>=0.61.0,<0.62"` |
| `TrustedHtml.nh3` | `pip install "hedron[sanitize]>=0.61.0,<0.62"` |
