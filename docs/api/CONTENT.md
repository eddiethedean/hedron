...
```bash
pip install "hedron[markdown]>=0.30.0,<0.31"
```
...
```bash
pip install "hedron[code]>=0.30.0,<0.31"
```
...
```bash
pip install "hedron[images]>=0.30.0,<0.31"
```
...
```bash
pip install "hedron[email]>=0.30.0,<0.31"
```
...
| API | Extra |
|---|---|
| `Markdown` | `pip install "hedron[markdown]>=0.30.0,<0.31"` |
| `highlight_code` | `pip install "hedron[code]>=0.30.0,<0.31"` |
| `process_image` | `pip install "hedron[images]>=0.30.0,<0.31"` |
| `validate_email_address` | `pip install "hedron[email]>=0.30.0,<0.31"` |
| `TrustedHtml.nh3` | `pip install "hedron[sanitize]>=0.30.0,<0.31"` |
