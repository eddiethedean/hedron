...
```bash
pip install "hedron[markdown]>=0.66.2,<0.67"
```
...
```bash
pip install "hedron[code]>=0.66.2,<0.67"
```
...
```bash
pip install "hedron[images]>=0.66.2,<0.67"
```
...
```bash
pip install "hedron[email]>=0.66.2,<0.67"
```
...
| API | Extra |
|---|---|
| `Markdown` | `pip install "hedron[markdown]>=0.66.2,<0.67"` |
| `highlight_code` | `pip install "hedron[code]>=0.66.2,<0.67"` |
| `process_image` | `pip install "hedron[images]>=0.66.2,<0.67"` |
| `validate_email_address` | `pip install "hedron[email]>=0.66.2,<0.67"` |
| `TrustedHtml.nh3` | `pip install "hedron[sanitize]>=0.66.2,<0.67"` |
