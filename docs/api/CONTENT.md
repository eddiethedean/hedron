...
```bash
pip install "hedron[markdown]>=0.50.0,<0.51"
```
...
```bash
pip install "hedron[code]>=0.50.0,<0.51"
```
...
```bash
pip install "hedron[images]>=0.50.0,<0.51"
```
...
```bash
pip install "hedron[email]>=0.50.0,<0.51"
```
...
| API | Extra |
|---|---|
| `Markdown` | `pip install "hedron[markdown]>=0.50.0,<0.51"` |
| `highlight_code` | `pip install "hedron[code]>=0.50.0,<0.51"` |
| `process_image` | `pip install "hedron[images]>=0.50.0,<0.51"` |
| `validate_email_address` | `pip install "hedron[email]>=0.50.0,<0.51"` |
| `TrustedHtml.nh3` | `pip install "hedron[sanitize]>=0.50.0,<0.51"` |
