...
```bash
pip install "hedron[markdown]>=0.26.0,<0.27"
```
...
```bash
pip install "hedron[code]>=0.26.0,<0.27"
```
...
```bash
pip install "hedron[images]>=0.26.0,<0.27"
```
...
```bash
pip install "hedron[email]>=0.26.0,<0.27"
```
...
| API | Extra |
|---|---|
| `Markdown` | `pip install "hedron[markdown]>=0.26.0,<0.27"` |
| `highlight_code` | `pip install "hedron[code]>=0.26.0,<0.27"` |
| `process_image` | `pip install "hedron[images]>=0.26.0,<0.27"` |
| `validate_email_address` | `pip install "hedron[email]>=0.26.0,<0.27"` |
| `TrustedHtml.nh3` | `pip install "hedron[sanitize]>=0.26.0,<0.27"` |
