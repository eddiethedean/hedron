...
```bash
pip install "hedron[markdown]>=0.35.0,<0.36"
```
...
```bash
pip install "hedron[code]>=0.35.0,<0.36"
```
...
```bash
pip install "hedron[images]>=0.35.0,<0.36"
```
...
```bash
pip install "hedron[email]>=0.35.0,<0.36"
```
...
| API | Extra |
|---|---|
| `Markdown` | `pip install "hedron[markdown]>=0.35.0,<0.36"` |
| `highlight_code` | `pip install "hedron[code]>=0.35.0,<0.36"` |
| `process_image` | `pip install "hedron[images]>=0.35.0,<0.36"` |
| `validate_email_address` | `pip install "hedron[email]>=0.35.0,<0.36"` |
| `TrustedHtml.nh3` | `pip install "hedron[sanitize]>=0.35.0,<0.36"` |
