...
```bash
pip install "hedron[markdown]>=0.45.0,<0.46"
```
...
```bash
pip install "hedron[code]>=0.45.0,<0.46"
```
...
```bash
pip install "hedron[images]>=0.45.0,<0.46"
```
...
```bash
pip install "hedron[email]>=0.45.0,<0.46"
```
...
| API | Extra |
|---|---|
| `Markdown` | `pip install "hedron[markdown]>=0.45.0,<0.46"` |
| `highlight_code` | `pip install "hedron[code]>=0.45.0,<0.46"` |
| `process_image` | `pip install "hedron[images]>=0.45.0,<0.46"` |
| `validate_email_address` | `pip install "hedron[email]>=0.45.0,<0.46"` |
| `TrustedHtml.nh3` | `pip install "hedron[sanitize]>=0.45.0,<0.46"` |
