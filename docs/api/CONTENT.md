...
```bash
pip install "hedron[markdown]>=0.31.0,<0.32"
```
...
```bash
pip install "hedron[code]>=0.31.0,<0.32"
```
...
```bash
pip install "hedron[images]>=0.31.0,<0.32"
```
...
```bash
pip install "hedron[email]>=0.31.0,<0.32"
```
...
| API | Extra |
|---|---|
| `Markdown` | `pip install "hedron[markdown]>=0.31.0,<0.32"` |
| `highlight_code` | `pip install "hedron[code]>=0.31.0,<0.32"` |
| `process_image` | `pip install "hedron[images]>=0.31.0,<0.32"` |
| `validate_email_address` | `pip install "hedron[email]>=0.31.0,<0.32"` |
| `TrustedHtml.nh3` | `pip install "hedron[sanitize]>=0.31.0,<0.32"` |
