...
```bash
pip install "hedron[markdown]>=0.36.0,<0.37"
```
...
```bash
pip install "hedron[code]>=0.36.0,<0.37"
```
...
```bash
pip install "hedron[images]>=0.36.0,<0.37"
```
...
```bash
pip install "hedron[email]>=0.36.0,<0.37"
```
...
| API | Extra |
|---|---|
| `Markdown` | `pip install "hedron[markdown]>=0.36.0,<0.37"` |
| `highlight_code` | `pip install "hedron[code]>=0.36.0,<0.37"` |
| `process_image` | `pip install "hedron[images]>=0.36.0,<0.37"` |
| `validate_email_address` | `pip install "hedron[email]>=0.36.0,<0.37"` |
| `TrustedHtml.nh3` | `pip install "hedron[sanitize]>=0.36.0,<0.37"` |
