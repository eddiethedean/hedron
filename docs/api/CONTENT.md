...
```bash
pip install "hedron[markdown]>=0.58.0,<0.60"
```
...
```bash
pip install "hedron[code]>=0.58.0,<0.60"
```
...
```bash
pip install "hedron[images]>=0.58.0,<0.60"
```
...
```bash
pip install "hedron[email]>=0.58.0,<0.60"
```
...
| API | Extra |
|---|---|
| `Markdown` | `pip install "hedron[markdown]>=0.58.0,<0.60"` |
| `highlight_code` | `pip install "hedron[code]>=0.58.0,<0.60"` |
| `process_image` | `pip install "hedron[images]>=0.58.0,<0.60"` |
| `validate_email_address` | `pip install "hedron[email]>=0.58.0,<0.60"` |
| `TrustedHtml.nh3` | `pip install "hedron[sanitize]>=0.58.0,<0.60"` |
