...
```bash
pip install "hedron[markdown]>=0.28.2,<0.29"
```
...
```bash
pip install "hedron[code]>=0.28.2,<0.29"
```
...
```bash
pip install "hedron[images]>=0.28.2,<0.29"
```
...
```bash
pip install "hedron[email]>=0.28.2,<0.29"
```
...
| API | Extra |
|---|---|
| `Markdown` | `pip install "hedron[markdown]>=0.28.2,<0.29"` |
| `highlight_code` | `pip install "hedron[code]>=0.28.2,<0.29"` |
| `process_image` | `pip install "hedron[images]>=0.28.2,<0.29"` |
| `validate_email_address` | `pip install "hedron[email]>=0.28.2,<0.29"` |
| `TrustedHtml.nh3` | `pip install "hedron[sanitize]>=0.28.2,<0.29"` |
