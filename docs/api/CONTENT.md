...
```bash
pip install "hedron[markdown]>=0.64.0,<0.65"
```
...
```bash
pip install "hedron[code]>=0.64.0,<0.65"
```
...
```bash
pip install "hedron[images]>=0.64.0,<0.65"
```
...
```bash
pip install "hedron[email]>=0.64.0,<0.65"
```
...
| API | Extra |
|---|---|
| `Markdown` | `pip install "hedron[markdown]>=0.64.0,<0.65"` |
| `highlight_code` | `pip install "hedron[code]>=0.64.0,<0.65"` |
| `process_image` | `pip install "hedron[images]>=0.64.0,<0.65"` |
| `validate_email_address` | `pip install "hedron[email]>=0.64.0,<0.65"` |
| `TrustedHtml.nh3` | `pip install "hedron[sanitize]>=0.64.0,<0.65"` |
