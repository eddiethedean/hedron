...
```bash
pip install "hedron[markdown]>=0.63.0,<0.64"
```
...
```bash
pip install "hedron[code]>=0.63.0,<0.64"
```
...
```bash
pip install "hedron[images]>=0.63.0,<0.64"
```
...
```bash
pip install "hedron[email]>=0.63.0,<0.64"
```
...
| API | Extra |
|---|---|
| `Markdown` | `pip install "hedron[markdown]>=0.63.0,<0.64"` |
| `highlight_code` | `pip install "hedron[code]>=0.63.0,<0.64"` |
| `process_image` | `pip install "hedron[images]>=0.63.0,<0.64"` |
| `validate_email_address` | `pip install "hedron[email]>=0.63.0,<0.64"` |
| `TrustedHtml.nh3` | `pip install "hedron[sanitize]>=0.63.0,<0.64"` |
