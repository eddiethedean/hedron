...
```bash
pip install "hedron[markdown]>=0.51.0,<0.52"
```
...
```bash
pip install "hedron[code]>=0.51.0,<0.52"
```
...
```bash
pip install "hedron[images]>=0.51.0,<0.52"
```
...
```bash
pip install "hedron[email]>=0.51.0,<0.52"
```
...
| API | Extra |
|---|---|
| `Markdown` | `pip install "hedron[markdown]>=0.51.0,<0.52"` |
| `highlight_code` | `pip install "hedron[code]>=0.51.0,<0.52"` |
| `process_image` | `pip install "hedron[images]>=0.51.0,<0.52"` |
| `validate_email_address` | `pip install "hedron[email]>=0.51.0,<0.52"` |
| `TrustedHtml.nh3` | `pip install "hedron[sanitize]>=0.51.0,<0.52"` |
