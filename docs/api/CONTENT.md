...
```bash
pip install "hedron[code]>=0.32.0,<0.33"
```
...
```bash
pip install "hedron[images]>=0.32.0,<0.33"
```
...
```bash
pip install "hedron[email]>=0.32.0,<0.33"
```
...
| API | Extra |
|---|---|
| `Markdown` | `pip install "hedron[markdown]>=0.32.0,<0.33"` |
| `highlight_code` | `pip install "hedron[code]>=0.32.0,<0.33"` |
| `process_image` | `pip install "hedron[images]>=0.32.0,<0.33"` |
| `validate_email_address` | `pip install "hedron[email]>=0.32.0,<0.33"` |
| `TrustedHtml.nh3` | `pip install "hedron[sanitize]>=0.32.0,<0.33"` |
