...
```bash
pip install "hedron[code]>=0.56.0,<0.59"
```
...
```bash
pip install "hedron[images]>=0.56.0,<0.59"
```
...
```bash
pip install "hedron[email]>=0.56.0,<0.59"
```
...
| API | Extra |
|---|---|
| `Markdown` | `pip install "hedron[markdown]>=0.56.0,<0.59"` |
| `highlight_code` | `pip install "hedron[code]>=0.56.0,<0.59"` |
| `process_image` | `pip install "hedron[images]>=0.56.0,<0.59"` |
| `validate_email_address` | `pip install "hedron[email]>=0.56.0,<0.59"` |
| `TrustedHtml.nh3` | `pip install "hedron[sanitize]>=0.56.0,<0.59"` |
