...
```bash
pip install "hedron[markdown]>=0.37.0,<0.38"
```
...
```bash
pip install "hedron[code]>=0.37.0,<0.38"
```
...
```bash
pip install "hedron[images]>=0.37.0,<0.38"
```
...
```bash
pip install "hedron[email]>=0.37.0,<0.38"
```
...
| API | Extra |
|---|---|
| `Markdown` | `pip install "hedron[markdown]>=0.37.0,<0.38"` |
| `highlight_code` | `pip install "hedron[code]>=0.37.0,<0.38"` |
| `process_image` | `pip install "hedron[images]>=0.37.0,<0.38"` |
| `validate_email_address` | `pip install "hedron[email]>=0.37.0,<0.38"` |
| `TrustedHtml.nh3` | `pip install "hedron[sanitize]>=0.37.0,<0.38"` |
