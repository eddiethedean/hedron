...
```bash
pip install "hedron[markdown]>=0.29.0,<0.30"
```
...
```bash
pip install "hedron[code]>=0.29.0,<0.30"
```
...
```bash
pip install "hedron[images]>=0.29.0,<0.30"
```
...
```bash
pip install "hedron[email]>=0.29.0,<0.30"
```
...
| API | Extra |
|---|---|
| `Markdown` | `pip install "hedron[markdown]>=0.29.0,<0.30"` |
| `highlight_code` | `pip install "hedron[code]>=0.29.0,<0.30"` |
| `process_image` | `pip install "hedron[images]>=0.29.0,<0.30"` |
| `validate_email_address` | `pip install "hedron[email]>=0.29.0,<0.30"` |
| `TrustedHtml.nh3` | `pip install "hedron[sanitize]>=0.29.0,<0.30"` |
