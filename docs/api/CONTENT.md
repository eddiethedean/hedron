...
```bash
pip install "hedron[markdown]>=0.60.0,<0.61"
```
...
```bash
pip install "hedron[code]>=0.60.0,<0.61"
```
...
```bash
pip install "hedron[images]>=0.60.0,<0.61"
```
...
```bash
pip install "hedron[email]>=0.60.0,<0.61"
```
...
| API | Extra |
|---|---|
| `Markdown` | `pip install "hedron[markdown]>=0.60.0,<0.61"` |
| `highlight_code` | `pip install "hedron[code]>=0.60.0,<0.61"` |
| `process_image` | `pip install "hedron[images]>=0.60.0,<0.61"` |
| `validate_email_address` | `pip install "hedron[email]>=0.60.0,<0.61"` |
| `TrustedHtml.nh3` | `pip install "hedron[sanitize]>=0.60.0,<0.61"` |
