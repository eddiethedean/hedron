...
```bash
pip install "hedron[markdown]>=0.22.0,<0.23"
```
...
```bash
pip install "hedron[code]>=0.22.0,<0.23"
```
...
```bash
pip install "hedron[images]>=0.22.0,<0.23"
```
...
```bash
pip install "hedron[email]>=0.22.0,<0.23"
```
...
| API | Extra |
|---|---|
| `Markdown` | `pip install "hedron[markdown]>=0.22.0,<0.23"` |
| `highlight_code` | `pip install "hedron[code]>=0.22.0,<0.23"` |
| `process_image` | `pip install "hedron[images]>=0.22.0,<0.23"` |
| `validate_email_address` | `pip install "hedron[email]>=0.22.0,<0.23"` |
| `TrustedHtml.nh3` | `pip install "hedron[sanitize]>=0.22.0,<0.23"` |
