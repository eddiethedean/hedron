...
```bash
pip install "hedron[markdown]>=0.46.0,<0.47"
```
...
```bash
pip install "hedron[code]>=0.46.0,<0.47"
```
...
```bash
pip install "hedron[images]>=0.46.0,<0.47"
```
...
```bash
pip install "hedron[email]>=0.46.0,<0.47"
```
...
| API | Extra |
|---|---|
| `Markdown` | `pip install "hedron[markdown]>=0.46.0,<0.47"` |
| `highlight_code` | `pip install "hedron[code]>=0.46.0,<0.47"` |
| `process_image` | `pip install "hedron[images]>=0.46.0,<0.47"` |
| `validate_email_address` | `pip install "hedron[email]>=0.46.0,<0.47"` |
| `TrustedHtml.nh3` | `pip install "hedron[sanitize]>=0.46.0,<0.47"` |
