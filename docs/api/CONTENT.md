...
```bash
pip install "hedron[markdown]>=0.62.0,<0.63"
```
...
```bash
pip install "hedron[code]>=0.62.0,<0.63"
```
...
```bash
pip install "hedron[images]>=0.62.0,<0.63"
```
...
```bash
pip install "hedron[email]>=0.62.0,<0.63"
```
...
| API | Extra |
|---|---|
| `Markdown` | `pip install "hedron[markdown]>=0.62.0,<0.63"` |
| `highlight_code` | `pip install "hedron[code]>=0.62.0,<0.63"` |
| `process_image` | `pip install "hedron[images]>=0.62.0,<0.63"` |
| `validate_email_address` | `pip install "hedron[email]>=0.62.0,<0.63"` |
| `TrustedHtml.nh3` | `pip install "hedron[sanitize]>=0.62.0,<0.63"` |
