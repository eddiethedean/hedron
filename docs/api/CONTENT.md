...
```bash
pip install "hedron[markdown]>=0.38.0,<0.39"
```
...
```bash
pip install "hedron[code]>=0.38.0,<0.39"
```
...
```bash
pip install "hedron[images]>=0.38.0,<0.39"
```
...
```bash
pip install "hedron[email]>=0.38.0,<0.39"
```
...
| API | Extra |
|---|---|
| `Markdown` | `pip install "hedron[markdown]>=0.38.0,<0.39"` |
| `highlight_code` | `pip install "hedron[code]>=0.38.0,<0.39"` |
| `process_image` | `pip install "hedron[images]>=0.38.0,<0.39"` |
| `validate_email_address` | `pip install "hedron[email]>=0.38.0,<0.39"` |
| `TrustedHtml.nh3` | `pip install "hedron[sanitize]>=0.38.0,<0.39"` |
