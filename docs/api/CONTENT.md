...
```bash
pip install "hedron[markdown]>=0.41.0,<0.42"
```
...
```bash
pip install "hedron[code]>=0.41.0,<0.42"
```
...
```bash
pip install "hedron[images]>=0.41.0,<0.42"
```
...
```bash
pip install "hedron[email]>=0.41.0,<0.42"
```
...
| API | Extra |
|---|---|
| `Markdown` | `pip install "hedron[markdown]>=0.41.0,<0.42"` |
| `highlight_code` | `pip install "hedron[code]>=0.41.0,<0.42"` |
| `process_image` | `pip install "hedron[images]>=0.41.0,<0.42"` |
| `validate_email_address` | `pip install "hedron[email]>=0.41.0,<0.42"` |
| `TrustedHtml.nh3` | `pip install "hedron[sanitize]>=0.41.0,<0.42"` |
