...
```bash
pip install "hedron[markdown]>=1.0.1,<1.1"
```
...
```bash
pip install "hedron[code]>=1.0.1,<1.1"
```
...
```bash
pip install "hedron[images]>=1.0.1,<1.1"
```
...
```bash
pip install "hedron[email]>=1.0.1,<1.1"
```
...
| API | Extra |
|---|---|
| `Markdown` | `pip install "hedron[markdown]>=1.0.1,<1.1"` |
| `highlight_code` | `pip install "hedron[code]>=1.0.1,<1.1"` |
| `process_image` | `pip install "hedron[images]>=1.0.1,<1.1"` |
| `validate_email_address` | `pip install "hedron[email]>=1.0.1,<1.1"` |
| `TrustedHtml.nh3` | `pip install "hedron[sanitize]>=1.0.1,<1.1"` |
