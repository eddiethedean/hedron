...
```bash
pip install "hedron[markdown]>=0.49.0,<0.50"
```
...
```bash
pip install "hedron[code]>=0.49.0,<0.50"
```
...
```bash
pip install "hedron[images]>=0.49.0,<0.50"
```
...
```bash
pip install "hedron[email]>=0.49.0,<0.50"
```
...
| API | Extra |
|---|---|
| `Markdown` | `pip install "hedron[markdown]>=0.49.0,<0.50"` |
| `highlight_code` | `pip install "hedron[code]>=0.49.0,<0.50"` |
| `process_image` | `pip install "hedron[images]>=0.49.0,<0.50"` |
| `validate_email_address` | `pip install "hedron[email]>=0.49.0,<0.50"` |
| `TrustedHtml.nh3` | `pip install "hedron[sanitize]>=0.49.0,<0.50"` |
