...
Portable contracts live in `hedron-core`. Living train: **0.51.x** (last published **v0.51.0**; latest on PyPI **v0.50.1**).
...
pip install "hedron-django>=0.50.1,<0.51"   # Django >=5.2,<6
```
