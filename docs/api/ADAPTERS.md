...
Portable contracts live in `hedron-core`. Living train: **0.49.x** (last published **v0.49.0**).
...
```bash
pip install "hedron-flask>=0.49.0,<0.50"
pip install "hedron-django>=0.49.0,<0.50"   # Django >=5.2,<6
```
