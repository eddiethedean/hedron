...
| `TRACE_CONTRACT_SCHEMA`, `decode_interaction_trace`, `encode_interaction_trace`, `profile_interaction_trace`, `element_metadata_manifest` | [Phase 0.63 implementation](https://github.com/eddiethedean/hedron/blob/main/docs/implementation/INTERACTION_TOOLING_063.md) |
