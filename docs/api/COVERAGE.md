...
| `LineChart`, `AreaChart`, `BarChart`, `ScatterChart`, `MatplotlibChart`, `PlotlyChart`, `AltairChart` | `hedron[charts]` (Beta; Matplotlib/static Supported, interactive hosts Experimental) | [CHART.md](CHART.md) |
