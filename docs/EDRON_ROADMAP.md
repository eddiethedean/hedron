...
**Status:** Edron `1.1.2` implemented, verified, tagged, and published<br>
**Edron release line:** `1.1` canonical Hedron 1.1 adoption<br>
**Latest in-tree release:** Edron `1.1.2`; Hedron `>=1.1.2`<br>
**Latest published release:** Edron `1.1.2` on PyPI (`v1.1.2`)<br>
