...
**Status:** Edron `1.0.16` implemented, verified, tagged, and published<br>
**Edron release line:** `1.0` canonical Hedron 1.0 adoption<br>
**Latest in-tree release:** Edron `1.0.16`; Hedron `>=1.0.0`<br>
**Latest published release:** Edron `1.0.16` on PyPI (`v1.0.16`)<br>
