...
Published **0.51.0** on PyPI. Pin `hedron>=0.56.0,<0.58` until the 0.51.2 wheel lands.
In-tree tip is **0.51.2**. Tracking [#507](https://github.com/eddiethedean/hedron/issues/507).

## 0.51.2

Quality and typing patch on the 0.51 train. Install from PyPI with `hedron>=0.56.0,<0.58`
...
Bugfix patch on the 0.51 train. Install from PyPI with `hedron>=0.56.0,<0.58`.
