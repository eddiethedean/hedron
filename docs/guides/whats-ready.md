...
This page is the **adopter** maturity summary for the published **1.1.1** release
...
BasedPyright `all` mode with all diagnostics and `Any` use blocked in CI. Commit and release CI use
the workspace package gate,
