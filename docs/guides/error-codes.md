...
| `HED-SEC-0020` | blocker | `TrustedHtml.nh3` without nh3 installed | `pip install "hedron[sanitize]>=1.0.0"` |
...
| `HED-CONTENT-0003` | blocker | Images extra missing | `pip install "hedron[images]>=1.0.0"` |
...
| `HED-DOCS-0102` | `HED_DOCS_0102` |
| `HED-DOCS-0103` | `HED_DOCS_0103` |
| `HED-DOCS-0104` | `HED_DOCS_0104` |
| `HED-DOCS-0105` | `HED_DOCS_0105` |
| `HED-DOCS-0106` | `HED_DOCS_0106` |
| `HED-DOCS-0107` | `HED_DOCS_0107` |
| `HED-DOCS-0108` | `HED_DOCS_0108` |
...
These catalog entries are retained for compatibility with diagnostics introduced in
earlier phases and remain registered in the central error-code catalog.

| Code | Catalog symbol |
|---|---|
| `HED-AUTHFLOW-0001` | `HED_AUTHFLOW_0001` |
| `HED-AUTHFLOW-0002` | `HED_AUTHFLOW_0002` |
| `HED-AUTHFLOW-0003` | `HED_AUTHFLOW_0003` |
| `HED-BRAND-0001` | `HED_BRAND_0001` |
| `HED-BRAND-0002` | `HED_BRAND_0002` |
| `HED-BRAND-0003` | `HED_BRAND_0003` |
| `HED-DASH-0001` | `HED_DASH_0001` |
| `HED-DASH-0002` | `HED_DASH_0002` |
| `HED-DASH-0003` | `HED_DASH_0003` |
| `HED-DESIGN-0001` | `HED_DESIGN_0001` |
| `HED-DESIGN-0002` | `HED_DESIGN_0002` |
| `HED-DESIGN-0003` | `HED_DESIGN_0003` |
| `HED-FAILURE-0001` | `HED_FAILURE_0001` |
| `HED-FAILURE-0002` | `HED_FAILURE_0002` |
| `HED-FAILURE-0003` | `HED_FAILURE_0003` |
| `HED-FAILURE-0004` | `HED_FAILURE_0004` |
| `HED-FAILURE-0005` | `HED_FAILURE_0005` |
| `HED-FAILURE-0006` | `HED_FAILURE_0006` |
| `HED-FAILURE-0007` | `HED_FAILURE_0007` |
| `HED-FEATURE-0001` | `HED_FEATURE_0001` |
| `HED-FEATURE-0002` | `HED_FEATURE_0002` |
| `HED-FEATURE-0003` | `HED_FEATURE_0003` |
| `HED-FORMCMD-0001` | `HED_FORMCMD_0001` |
| `HED-FORMCMD-0002` | `HED_FORMCMD_0002` |
| `HED-FORMCMD-0003` | `HED_FORMCMD_0003` |
| `HED-IDENTITY-0001` | `HED_IDENTITY_0001` |
| `HED-IDENTITY-0002` | `HED_IDENTITY_0002` |
| `HED-IDENTITY-0003` | `HED_IDENTITY_0003` |
| `HED-IDENTITY-0004` | `HED_IDENTITY_0004` |
| `HED-IDENTITY-0005` | `HED_IDENTITY_0005` |
| `HED-IDENTITY-0006` | `HED_IDENTITY_0006` |
| `HED-NAV-0001` | `HED_NAV_0001` |
| `HED-NAV-0005` | `HED_NAV_0005` |
| `HED-NAV-0006` | `HED_NAV_0006` |
| `HED-OPTIMISTIC-0001` | `HED_OPTIMISTIC_0001` |
| `HED-OPTIMISTIC-0002` | `HED_OPTIMISTIC_0002` |
| `HED-PREFETCH-0001` | `HED_PREFETCH_0001` |
| `HED-RECIPE-0001` | `HED_RECIPE_0001` |
| `HED-RECIPE-0002` | `HED_RECIPE_0002` |
| `HED-RECIPE-0003` | `HED_RECIPE_0003` |
| `HED-RECIPE-0004` | `HED_RECIPE_0004` |
| `HED-SCREEN-0001` | `HED_SCREEN_0001` |
| `HED-SCREEN-0002` | `HED_SCREEN_0002` |
| `HED-SCREEN-0003` | `HED_SCREEN_0003` |
| `HED-STYLE-APP-0001` | `HED_STYLE_APP_0001` |
| `HED-STYLE-APP-0002` | `HED_STYLE_APP_0002` |
| `HED-STYLE-EJECT-0001` | `HED_STYLE_EJECT_0001` |
| `HED-STYLE-EJECT-0002` | `HED_STYLE_EJECT_0002` |
| `HED-STYLE-EJECT-0003` | `HED_STYLE_EJECT_0003` |
| `HED-STYLE-SCOPE-0001` | `HED_STYLE_SCOPE_0001` |
| `HED-STYLE-SCOPE-0002` | `HED_STYLE_SCOPE_0002` |
| `HED-TASKFLOW-0001` | `HED_TASKFLOW_0001` |
| `HED-TASKFLOW-0002` | `HED_TASKFLOW_0002` |
| `HED-TASKFLOW-0003` | `HED_TASKFLOW_0003` |
| `HED-UPLOADFLOW-0001` | `HED_UPLOADFLOW_0001` |
| `HED-UPLOADFLOW-0002` | `HED_UPLOADFLOW_0002` |
| `HED-UPLOADFLOW-0003` | `HED_UPLOADFLOW_0003` |
