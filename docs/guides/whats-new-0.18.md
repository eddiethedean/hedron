...
!!! note "Historical phase"
    ...
    This page describes **0.18**. The current published train is **0.36.x** (last `v0.36.0`). Pin `hedron>=0.36.0,<0.37`.
...
Prefer the current 0.36 train for new apps; stay on a historical upper-bound pin
