...
!!! note "Historical phase"
    ...
    This page describes **0.18**. The current published train is **0.40.x** (last `v0.40.0`). Pin `hedron>=0.40.0,<0.41`.
...
Prefer the current 0.40 train for new apps; stay on a historical upper-bound pin
