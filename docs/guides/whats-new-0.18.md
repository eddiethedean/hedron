...
!!! note "Historical phase"
    ...
    This page describes **0.18**. The current published train is **0.42.x** (last `v0.42.0`). Pin `hedron>=0.42.0,<0.43`.
...
Prefer the current 0.42 train for new apps; stay on a historical upper-bound pin
