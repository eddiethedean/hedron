...
!!! note "Historical phase"
    ...
    This page describes **0.18**. The current published train is **0.41.x** (last `v0.41.0`). Pin `hedron>=0.41.0,<0.42`.
...
Prefer the current 0.41 train for new apps; stay on a historical upper-bound pin
