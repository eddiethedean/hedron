...
!!! note "Historical phase"
    ...
    This page describes **0.18**. The current published train is **0.59.x** (last `v0.58.0`). Pin `hedron>=0.58.0,<0.60` from PyPI.
...
Prefer the current 0.59 train for new apps; stay on a historical upper-bound pin
