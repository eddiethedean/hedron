...
!!! note "Historical phase"
    ...
    This page describes **0.18**. The current published train is **0.48.x** (last `v0.48.0`). Pin `hedron>=0.48.0,<0.49`.
...
Prefer the current 0.48 train for new apps; stay on a historical upper-bound pin
