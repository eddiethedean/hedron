...
!!! note "Historical phase"
    ...
    This page describes **0.18**. The current published train is **0.51.x** (last `v0.51.0`). Pin `hedron>=0.50.1,<0.51`.
...
Prefer the current 0.51 train for new apps; stay on a historical upper-bound pin
