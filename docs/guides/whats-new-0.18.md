...
!!! note "Historical phase"
    ...
    This page describes **0.18**. The current published train is **0.39.x** (last `v0.39.0`). Pin `hedron>=0.39.0,<0.40`.
...
Prefer the current 0.39 train for new apps; stay on a historical upper-bound pin
