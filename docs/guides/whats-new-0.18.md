...
!!! note "Current train is 0.50"
    ...
    Pin `hedron>=0.50.1,<0.51` for new apps. The pin below is historical for this train only.
    See [What’s new in 0.50](whats-new-0.50.md).

!!! note "Historical phase"

    This page describes **0.18**. The current published train is **0.50.x** (last `v0.50.1`). Pin `hedron>=0.50.1,<0.51`.
...
Prefer the current 0.50 train for new apps; stay on a historical upper-bound pin
