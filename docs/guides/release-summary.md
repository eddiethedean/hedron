...
| Item | Value |
|---|---|
| In-tree | **v0.50.2** (`hedron` / Beta train packages `0.50.2`; Git tag/PyPI deferred) |
...
| Gate checker | `python scripts/check_release_gate.py 0.50.2` |
...
Tag `v0.50.2` only after CI on `main` is green (not part of this in-tree cut). Do not retag `v0.50.1`, `v0.49.1`, `v0.48.0`, or `v0.47.0`.
