...
| Item | Value |
|---|---|
| In-tree | **v0.51.0** (`hedron` / Beta train packages `0.51.0`) |
...
| Gate checker | `python scripts/check_release_gate.py 0.51.0` |
...
Tag `v0.50.3` only after CI on `main` is green. Do not retag `v0.50.2`, `v0.50.1`, `v0.49.1`, `v0.48.0`, or `v0.47.0`.
