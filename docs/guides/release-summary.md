...
| Item | Value |
|---|---|
| Published | **v0.22.0** (`hedron` / Beta packages `0.22.0`) |
| Pin | `hedron>=0.22.0,<0.23` |
| Gate checker | `python scripts/check_release_gate.py 0.22.0` |
| Packet verify | `python scripts/verify_pkg_22.py` |

Adopter-facing notes: [What’s new in 0.22](whats-new-0.22.md) ·
