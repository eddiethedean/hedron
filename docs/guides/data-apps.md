...
# optional backends
pip install "hedron-data[pandas]>=0.48.0,<0.49"
```
...
```bash
pip install "hedron-data[sqlalchemy]>=0.48.0,<0.49"
```
...
Install `hedron[charts]>=0.48.0,<0.49`; the flagship extra resolves the compatible
