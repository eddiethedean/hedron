...
# optional backends
pip install "hedron-data[pandas]>=0.44.0,<0.45"
```
...
```bash
pip install "hedron-data[sqlalchemy]>=0.44.0,<0.45"
```
...
Install `hedron[charts]>=0.44.0,<0.45`; the flagship extra resolves the compatible
