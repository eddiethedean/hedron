...
# optional backends
pip install "hedron-data[pandas]>=0.59.0,<0.60"
```
...
```bash
pip install "hedron-data[sqlalchemy]>=0.59.0,<0.60"
```
...
Install `hedron[charts]>=0.59.0,<0.60`; the flagship extra resolves the compatible
