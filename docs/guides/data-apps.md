...
# optional backends
pip install "hedron-data[pandas]>=0.51.0,<0.52"
```
...
```bash
pip install "hedron-data[sqlalchemy]>=0.51.0,<0.52"
```
...
Install `hedron[charts]>=0.51.0,<0.52`; the flagship extra resolves the compatible
