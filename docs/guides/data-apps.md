...
```bash
pip install "hedron[data]>=0.45.0,<0.46"
# optional backends
pip install "hedron-data[pandas]>=0.45.0,<0.46"
```
...
```bash
pip install "hedron-data[sqlalchemy]>=0.45.0,<0.46"
```
...
Install `hedron[charts]>=0.45.0,<0.46`; the flagship extra resolves the compatible
