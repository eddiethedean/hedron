...
```bash
pip install "hedron[data]>=0.42.0,<0.43"
# optional backends
pip install "hedron-data[pandas]>=0.42.0,<0.43"
```
...
```bash
pip install "hedron-data[sqlalchemy]>=0.42.0,<0.43"
```
...
Install `hedron[charts]>=0.42.0,<0.43`; the flagship extra resolves the compatible
