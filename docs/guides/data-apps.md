...
# optional backends
pip install "hedron-data[pandas]>=0.39.0,<0.40"
```
...
```bash
pip install "hedron-data[sqlalchemy]>=0.39.0,<0.40"
```
...
Install `hedron[charts]>=0.39.0,<0.40`; the flagship extra resolves the compatible
