...
```bash
uv add "hedron[data]>=0.60.0,<0.61" "uvicorn[standard]"
```
...
| `st.line_chart` | `LineChart` (`hedron[charts]>=0.60.0,<0.61`) | Provide a title and accessible description; a table fallback remains useful. |
