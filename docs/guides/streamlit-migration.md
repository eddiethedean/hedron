...
```bash
uv add "hedron[data]>=0.58.0,<0.59" "uvicorn[standard]"
```
...
| `st.line_chart` | `LineChart` (`hedron[charts]>=0.58.0,<0.59`) | Provide a title and accessible description; a table fallback remains useful. |
