...
**Status:** Maintained for the **0.25** train (**Published** as `v0.25.0`; last published
PyPI/git = `v0.25.0`; baseline established in 0.11; refreshed for 0.15–0.25 surfaces)  
