...
Current release: **v0.51.2** in-tree (**v0.51.0** on PyPI). Recommended constraint:
`hedron>=0.51.0,<0.52`. Public-index notes: [Installation](../getting-started/installation.md).

Continue with:

- [Upgrade to 0.51](upgrade.md)
