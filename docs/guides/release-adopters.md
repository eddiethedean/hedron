...
Current repository cut: **v0.58.1**; PyPI serves **v0.58.0**. Recommended constraint:
`hedron>=0.58.0,<0.59`. Public-index notes: [Installation](../getting-started/installation.md).
