...
For new apps, pin `hedron>=0.56.0,<0.59`; see [What’s new in 0.51](whats-new-0.51.md).
...
Historical 0.45 pin was `hedron>=0.45.0,<0.46`. For new apps, pin `hedron>=0.56.0,<0.59`.
