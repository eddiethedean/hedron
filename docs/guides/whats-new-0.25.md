...
**Published** as `v0.25.0` (last 0.25 patch `v0.25.2`). Living train is **0.28** — pin `hedron>=0.28.1,<0.29`.
...
| If you… | Do this |
|---|---|
| Are on 0.24 | Pin `>=0.28.1,<0.29`; follow the [current upgrade guide](upgrade.md) |
