...
!!! note "Historical phase"
    ...
    This page describes **0.17**. The current published train is **0.57.x** (last `v0.57.0`). Pin `hedron>=0.56.0,<0.58` from checkout (PyPI still `>=0.56.0,<0.58` while deferred).
