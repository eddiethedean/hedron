...
Capability readiness is **Supported** on the living **0.64.x** train; API compatibility
remains **`beta`** — pin `hedron>=0.64.0,<0.65` from PyPI (in-tree as `v0.64.0`; PyPI upload deferred).
