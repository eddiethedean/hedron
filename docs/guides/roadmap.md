...
| **0.33** | Unified `hedron-posit` facade for ordinary Hedron, Posit Workbench, and Posit Connect | Planned (RFC-0066 **Accepted**; packet refine complete; Stage 1 ready); D-061; [#167](https://github.com/eddiethedean/hedron/issues/167). Supported cookie bridge dropped after Stage 0. Presentation gallery work is cross-cutting and must not block the Posit adapter. |
