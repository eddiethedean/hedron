...
## Honest gaps on the current train (0.21)

- Current **published** PyPI train is **0.21.x** (`v0.21.0`)
...
CSRF / SecurityPolicy composition (#36–#38) is **0.22**. Human AT evaluation engineering is
