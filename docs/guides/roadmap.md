...
| **0.17** | Reactive dashboards and agent interfaces; shell NavLink/OobHost/`class_` | Planned |
| **0.18** | Model demos and inference workflows | Planned |
| **0.19** | Accessibility engineering; progressive enhancement; landmark attrs/types | Planned |
