...
**Living published train:** in-tree pin `hedron>=0.58.0,<0.59` (tip `v0.58.0`); from PyPI
pin `hedron>=0.56.0,<0.59` while the Git tag / upload is deferred. Capability maturity snapshot:
