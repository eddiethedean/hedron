...
**Living repository train:** pin `hedron>=0.60.2,<0.61` for public PyPI installs (`v0.60.2` in-tree and on PyPI).
pin `hedron>=0.60.2,<0.61`. Capability maturity snapshot:
