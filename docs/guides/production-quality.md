...
**Living repository train:** pin `hedron>=0.60.0,<0.61` for public PyPI installs (`v0.60.0` in-tree; PyPI remains `v0.59.0` until upload).
pin `hedron>=0.60.0,<0.61`. Capability maturity snapshot:
