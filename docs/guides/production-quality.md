...
**Living repository train:** pin `hedron>=0.59.0,<0.60` for public PyPI installs (`v0.60.0` in-tree; PyPI remains `v0.59.0` until upload).
pin `hedron>=0.59.0,<0.60`. Capability maturity snapshot:
