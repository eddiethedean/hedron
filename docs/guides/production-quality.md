...
**Living published train:** in-tree pin `hedron>=0.56.1,<0.57` (tip `v0.56.1`); from PyPI
pin `hedron>=0.56.0,<0.57` while the Git tag / upload is deferred. Capability maturity snapshot:
