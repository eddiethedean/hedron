...
**Preferred for new apps:** `hedron-posit>=0.39.0,<0.40` (or
`hedron[posit]>=0.39.0,<0.40`). **Compatibility surface:**
`hedron-workbench>=0.39.0,<0.40` (or `hedron[workbench]>=0.39.0,<0.40`).
