...
**Preferred for new apps:** `hedron-posit>=0.48.0,<0.49` (or
`hedron[posit]>=0.48.0,<0.49`). **Compatibility surface:**
`hedron-workbench>=0.48.0,<0.49` (or `hedron[workbench]>=0.48.0,<0.49`).
