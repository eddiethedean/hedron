...
**Preferred for new apps:** `hedron-posit>=0.47.0,<0.48` (or
`hedron[posit]>=0.47.0,<0.48`). **Compatibility surface:**
`hedron-workbench>=0.47.0,<0.48` (or `hedron[workbench]>=0.47.0,<0.48`).
