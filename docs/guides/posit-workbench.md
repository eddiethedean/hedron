...
**Preferred for new apps:** `hedron-posit>=0.45.0,<0.46` (or
`hedron[posit]>=0.45.0,<0.46`). **Compatibility surface:**
`hedron-workbench>=0.45.0,<0.46` (or `hedron[workbench]>=0.45.0,<0.46`).
