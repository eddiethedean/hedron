...
**Preferred for new apps:** `hedron-posit>=0.58.0,<0.59` (or
`hedron[posit]>=0.58.0,<0.59`). **Compatibility surface:**
`hedron-workbench>=0.58.0,<0.59` (or `hedron[workbench]>=0.58.0,<0.59`).
