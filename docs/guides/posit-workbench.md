...
**Preferred for new apps:** `hedron-posit>=0.59.0,<0.60` (or
`hedron[posit]>=0.59.0,<0.60`). **Compatibility surface:**
`hedron-workbench>=0.59.0,<0.60` (or `hedron[workbench]>=0.59.0,<0.60`).
