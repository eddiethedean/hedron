...
**Preferred for new apps:** `hedron-posit>=0.49.1,<0.50` (or
`hedron[posit]>=0.49.1,<0.50`). **Compatibility surface:**
`hedron-workbench>=0.49.1,<0.50` (or `hedron[workbench]>=0.49.1,<0.50`).
