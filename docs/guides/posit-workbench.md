...
**Preferred for new apps:** `hedron-posit>=0.61.0,<0.62` (or
`hedron[posit]>=0.61.0,<0.62`). **Compatibility surface:**
`hedron-workbench>=0.61.0,<0.62` (or `hedron[workbench]>=0.61.0,<0.62`).
