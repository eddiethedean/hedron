...
**Preferred for new apps:** `hedron-posit>=0.51.0,<0.52` (or
`hedron[posit]>=0.51.0,<0.52`). **Compatibility surface:**
`hedron-workbench>=0.51.0,<0.52` (or `hedron[workbench]>=0.51.0,<0.52`).
