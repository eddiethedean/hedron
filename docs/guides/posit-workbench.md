...
**Preferred for new apps:** `hedron-posit>=0.60.0,<0.61` (or
`hedron[posit]>=0.60.0,<0.61`). **Compatibility surface:**
`hedron-workbench>=0.60.0,<0.61` (or `hedron[workbench]>=0.60.0,<0.61`).
