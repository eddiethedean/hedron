...
**Preferred for new apps:** `hedron-posit>=0.46.0,<0.47` (or
`hedron[posit]>=0.46.0,<0.47`). **Compatibility surface:**
`hedron-workbench>=0.46.0,<0.47` (or `hedron[workbench]>=0.46.0,<0.47`).
