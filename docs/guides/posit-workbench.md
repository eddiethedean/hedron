...
**Preferred for new apps:** `hedron-posit>=0.44.0,<0.45` (or
`hedron[posit]>=0.44.0,<0.45`). **Compatibility surface:**
`hedron-workbench>=0.44.0,<0.45` (or `hedron[workbench]>=0.44.0,<0.45`).
