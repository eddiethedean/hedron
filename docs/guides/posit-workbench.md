...
**Preferred for new apps:** `hedron-posit>=0.62.0,<0.63` (or
`hedron[posit]>=0.62.0,<0.63`). **Compatibility surface:**
`hedron-workbench>=0.62.0,<0.63` (or `hedron[workbench]>=0.62.0,<0.63`).
