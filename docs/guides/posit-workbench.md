...
**Preferred for new apps:** `hedron-posit>=0.50.0,<0.51` (or
`hedron[posit]>=0.50.0,<0.51`). **Compatibility surface:**
`hedron-workbench>=0.50.0,<0.51` (or `hedron[workbench]>=0.50.0,<0.51`).
