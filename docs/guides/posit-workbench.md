...
**Preferred for new apps:** `hedron-posit>=0.63.0,<0.64` (or
`hedron[posit]>=0.63.0,<0.64`). **Compatibility surface:**
`hedron-workbench>=0.63.0,<0.64` (or `hedron[workbench]>=0.63.0,<0.64`).
