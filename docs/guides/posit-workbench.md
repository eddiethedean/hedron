...
**Preferred for new apps:** `hedron-posit>=0.43.0,<0.44` (or
`hedron[posit]>=0.43.0,<0.44`). **Compatibility surface:**
`hedron-workbench>=0.43.0,<0.44` (or `hedron[workbench]>=0.43.0,<0.44`).
