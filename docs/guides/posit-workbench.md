...
**Preferred for new apps:** `hedron-posit>=0.42.0,<0.43` (or
`hedron[posit]>=0.42.0,<0.43`). **Compatibility surface:**
`hedron-workbench>=0.42.0,<0.43` (or `hedron[workbench]>=0.42.0,<0.43`).
