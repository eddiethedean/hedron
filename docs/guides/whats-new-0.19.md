...
**Published as `v0.19.0`** (2026-08-07). Living published train is **0.21.0**. Historical pin for this phase was `hedron>=0.19.0,<0.20`; current train
is `hedron>=0.21.0,<0.22`.
