...
- Stable coordinated packages, including `hedron-posit`; `hedron-workbench` was removed.
- Python 3.11–3.14, FastAPI, Flask, Django, HDJ, browser, security, and package evidence.
