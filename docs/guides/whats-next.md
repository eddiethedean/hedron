...
| Progressive feature and styling authoring (0.58) | **Published/Verified `v0.58.0` on PyPI** ([RFC-0085](https://github.com/eddiethedean/hedron/blob/main/docs/rfcs/RFC-0085-PROGRESSIVE-FEATURE-AUTHORING.md), D-101/D-102/D-105) |
