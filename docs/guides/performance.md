...
Application-oriented guidance for the living **0.38** train. CI soft ceilings live in
...
- Install `hedron[data]` only when needed. Charts require
  `hedron[charts]>=0.38.0,<0.39` ([Compatibility](../COMPATIBILITY.md#charts-and-sample-kit-compatibility-floor))
