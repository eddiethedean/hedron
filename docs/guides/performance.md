...
Application-oriented guidance for the living **0.57** train. CI soft ceilings live in
...
- Install `hedron[data]` only when needed. Charts require
  `hedron[charts]>=0.56.0,<0.58` ([Compatibility](../COMPATIBILITY.md#charts-and-sample-kit-compatibility-floor))
