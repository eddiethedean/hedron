...
Application-oriented guidance for the living **0.60** train. CI soft ceilings live in
...
- Install `hedron[data]` only when needed. Charts require
  `hedron[charts]>=0.60.0,<0.61` ([Compatibility](../COMPATIBILITY.md#charts-and-sample-kit-compatibility-floor))
