...
Application-oriented guidance for the living **0.42** train. CI soft ceilings live in
...
- Install `hedron[data]` only when needed. Charts require
  `hedron[charts]>=0.42.0,<0.43` ([Compatibility](../COMPATIBILITY.md#charts-and-sample-kit-compatibility-floor))
