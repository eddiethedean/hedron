...
Application-oriented guidance for the living **0.43** train. CI soft ceilings live in
...
- Install `hedron[data]` only when needed. Charts require
  `hedron[charts]>=0.43.0,<0.44` ([Compatibility](../COMPATIBILITY.md#charts-and-sample-kit-compatibility-floor))
