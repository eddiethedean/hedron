...
Application-oriented guidance for the living **0.51** train. CI soft ceilings live in
...
- Install `hedron[data]` only when needed. Charts require
  `hedron[charts]>=0.50.1,<0.51` ([Compatibility](../COMPATIBILITY.md#charts-and-sample-kit-compatibility-floor))
