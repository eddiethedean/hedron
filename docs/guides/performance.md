...
Application-oriented guidance for the living **0.63.x** train. CI soft ceilings live in
...
- Install `hedron[data]` only when needed. Charts require
  `hedron[charts]>=0.63.0,<0.64` ([Compatibility](../COMPATIBILITY.md#charts-and-sample-kit-compatibility-floor))
