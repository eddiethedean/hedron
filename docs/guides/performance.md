...
Application-oriented guidance for the living **0.35** train. CI soft ceilings live in
...
- Install `hedron[data]` only when needed. Charts require
  `hedron[charts]>=0.35.0,<0.36` ([Compatibility](../COMPATIBILITY.md#charts-and-sample-kit-compatibility-floor))
