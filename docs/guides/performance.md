...
Application-oriented guidance for the living **0.49** train. CI soft ceilings live in
...
- Install `hedron[data]` only when needed. Charts require
  `hedron[charts]>=0.49.0,<0.50` ([Compatibility](../COMPATIBILITY.md#charts-and-sample-kit-compatibility-floor))
