...
Application-oriented guidance for the living **0.26** train. CI soft ceilings live in
...
- Install `hedron[data]` only when needed. Charts require
  `hedron[charts]>=0.27.0,<0.28` ([Compatibility](../COMPATIBILITY.md#charts-and-sample-kit-compatibility-floor))
