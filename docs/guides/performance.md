...
Application-oriented guidance for the living **0.45** train. CI soft ceilings live in
...
- Install `hedron[data]` only when needed. Charts require
  `hedron[charts]>=0.45.0,<0.46` ([Compatibility](../COMPATIBILITY.md#charts-and-sample-kit-compatibility-floor))
