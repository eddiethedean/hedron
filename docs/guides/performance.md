...
Application-oriented guidance for the living **0.48** train. CI soft ceilings live in
...
- Install `hedron[data]` only when needed. Charts require
  `hedron[charts]>=0.48.0,<0.49` ([Compatibility](../COMPATIBILITY.md#charts-and-sample-kit-compatibility-floor))
