...
Application-oriented guidance for the living **0.28** train. CI soft ceilings live in
...
- Install `hedron[data]` only when needed. Charts require
  `hedron[charts]>=0.28.0,<0.29` ([Compatibility](../COMPATIBILITY.md#charts-and-sample-kit-compatibility-floor))
