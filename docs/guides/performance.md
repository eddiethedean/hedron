...
Application-oriented guidance for the living **0.31** train. CI soft ceilings live in
...
- Install `hedron[data]` only when needed. Charts require
  `hedron[charts]>=0.31.0,<0.32` ([Compatibility](../COMPATIBILITY.md#charts-and-sample-kit-compatibility-floor))
