...
Application-oriented guidance for the living **0.39** train. CI soft ceilings live in
...
- Install `hedron[data]` only when needed. Charts require
  `hedron[charts]>=0.39.0,<0.40` ([Compatibility](../COMPATIBILITY.md#charts-and-sample-kit-compatibility-floor))
