...
Application-oriented guidance for the living **0.52** train. CI soft ceilings live in
...
- Install `hedron[data]` only when needed. Charts require
  `hedron[charts]>=0.51.0,<0.52` ([Compatibility](../COMPATIBILITY.md#charts-and-sample-kit-compatibility-floor))
