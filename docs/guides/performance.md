...
Application-oriented guidance for the living **0.29** train. CI soft ceilings live in
...
- Install `hedron[data]` only when needed. Charts require
  `hedron[charts]>=0.29.0,<0.30` ([Compatibility](../COMPATIBILITY.md#charts-and-sample-kit-compatibility-floor))
