...
Application-oriented guidance for the living **0.47** train. CI soft ceilings live in
...
- Install `hedron[data]` only when needed. Charts require
  `hedron[charts]>=0.47.0,<0.48` ([Compatibility](../COMPATIBILITY.md#charts-and-sample-kit-compatibility-floor))
