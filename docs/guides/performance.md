...
Application-oriented guidance for the living **0.32** train. CI soft ceilings live in
...
- Install `hedron[data]` only when needed. Charts require
  `hedron[charts]>=0.32.0,<0.33` ([Compatibility](../COMPATIBILITY.md#charts-and-sample-kit-compatibility-floor))
