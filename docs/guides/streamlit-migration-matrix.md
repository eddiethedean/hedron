...
| `st.line_chart`, `st.area_chart`, `st.bar_chart`, `st.scatter_chart` | Hedron chart components | **Partial** | Install `hedron[charts]>=0.66.2,<0.67`; provide accessible titles/descriptions/fallbacks. |
