...
**Published Beta package:** use `hedron-posit>=1.0.2` or the repository checkout. For plain FastAPI/ASGI applications,
use the independent `fastapi-workbench>=1.0.2` package instead.
