...
| Evidence | Source |
|---|---|
| Hedron package and files | Published `1.0.7` |
| Edron package and files | Published `1.0.7` |
| Source tag, wheels, checksums, and attached evidence | Published from immutable `v1.0.7` tag |
