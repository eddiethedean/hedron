...
| Evidence | Source |
|---|---|
| Hedron package and files | Published `1.0.6` |
| Edron package and files | Published `1.0.6` |
| Source tag, wheels, checksums, and attached evidence | Published from immutable `v1.0.6` tag |
