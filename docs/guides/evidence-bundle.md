...
| Evidence | Source |
|---|---|
| Hedron package and files | Published `1.0.4` |
| Edron package and files | Published `1.0.4` |
| Source tag, wheels, checksums, and attached evidence | Published from immutable `v1.0.4` tag |
