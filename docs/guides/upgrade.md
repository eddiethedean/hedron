...
This guide covers an application upgrade from **0.28.x** to the **0.31.x** train
(current tip **`v0.31.0`**). New applications should use
[Build your first app](../getting-started/quickstart.md).

## Summary

Hedron 0.31.x ships production-grade `hedron-workbench` (D-057 / RFC-0062): an
