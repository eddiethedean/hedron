...
Hedron 0.35.x ships **`hedron-posit`** as the preferred Posit Workbench / Connect
...
python -m pip install -U "hedron[posit]>=0.35.0,<0.36"
# compatibility:
python -m pip install -U "hedron[workbench]>=0.35.0,<0.36"
```
