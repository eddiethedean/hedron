...
- **Stable** documents the newest published release, currently **1.0.15**.
- **Latest** follows `main` and may describe the **1.0.15 development workspace** before
  those changes are released.
- A numbered version such as **1.0.15** is an immutable snapshot built from that Git tag.
