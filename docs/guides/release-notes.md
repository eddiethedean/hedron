...
`hedron>=0.58.0,<0.59`. [What’s new in 0.58](whats-new-0.58.md).
...
`hedron>=0.58.0,<0.59`. [What’s new in 0.57](whats-new-0.57.md).
[Installation](../getting-started/installation.md).
...
`hedron>=0.58.0,<0.59`. [What’s new in 0.56](whats-new-0.56.md).
[Installation](../getting-started/installation.md).
...
(RFC-0082 / D-095 / D-096). Pin `hedron>=0.58.0,<0.59` from PyPI until the 0.55
...
(RFC-0080 / D-091 / D-092). Pin `hedron>=0.58.0,<0.59` from PyPI until the 0.53
...
Pin `hedron>=0.58.0,<0.59` from the public index (0.53 remains deferred).
...
Quality and typing patch on the 0.51 train. Pin `hedron>=0.58.0,<0.59` from PyPI until the
...
Bugfix patch on the 0.51 train. Pin `hedron>=0.58.0,<0.59` from PyPI until a later
...
Published curated extras cut. Install from PyPI with `hedron>=0.58.0,<0.59`.
...
from PyPI `hedron>=0.58.0,<0.59` — [Installation](../getting-started/installation.md).
...
```bash
python -m pip install -U "hedron>=0.58.0,<0.59"
```
...
```bash
python -m pip install -U "hedron>=0.58.0,<0.59"
python -m pip install "hedron[maps]>=0.58.0,<0.59"
python -m pip install "hedron[data]>=0.58.0,<0.59"
python -m pip install "hedron[charts]>=0.58.0,<0.59"
...
python -m pip install "hedron[data]>=0.58.0,<0.59"
python -m pip install "hedron[charts]>=0.58.0,<0.59"
python -m pip install "hedron[elements]>=0.58.0,<0.59"
python -m pip install "hedron-charts>=0.2.0,<0.3"
```
...
- Pin `hedron>=0.58.0,<0.59`. Charts remain on `hedron-charts>=0.2.0,<0.3`.
