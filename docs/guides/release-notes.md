...
`fastapi-workbench>=1.0.0,<2.0`. Prefer the current tip pin under **0.37.0** above.
...
Install the current tip with the pin under **0.37.0** above (historical cut pin was
`>=0.28.2,<0.29`).
...
Install the current tip with the pin under **0.37.0** above.
...
[Upgrade to 0.37](upgrade.md) / [What’s new in 0.37](whats-new-0.37.md).
