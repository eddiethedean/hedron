...
python -m pip install "hedron[data]>=0.44.0,<0.45"
python -m pip install "hedron[charts]>=0.44.0,<0.45"
python -m pip install "hedron[elements]>=0.44.0,<0.45"
...
- Historical cut; install the current tip with the pin under **0.44.0** above.
...
- Historical cut pin `hedron>=0.40.0,<0.42`. Install the current tip with the pin under
  **0.44.0** above. Charts remain on `hedron-charts>=0.2.0,<0.3`.
...
`fastapi-workbench>=1.0.0,<2.0`. Prefer the current tip pin under **0.44.0** above.
...
Install the current tip with the pin under **0.44.0** above (historical cut pin was
`>=0.28.2,<0.29`).
...
Install the current tip with the pin under **0.44.0** above.
...
[Upgrade to 0.44](upgrade.md) / [What’s new in 0.44](whats-new-0.44.md).
