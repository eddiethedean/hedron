...
(RFC-0080 / D-091 / D-092). Pin `hedron>=0.54.0,<0.55` from PyPI until the 0.53
...
Pin `hedron>=0.54.0,<0.55` from the public index (0.53 remains deferred).
...
Quality and typing patch on the 0.51 train. Pin `hedron>=0.54.0,<0.55` from PyPI until the
...
Bugfix patch on the 0.51 train. Pin `hedron>=0.54.0,<0.55` from PyPI until a later
...
Published curated extras cut. Install from PyPI with `hedron>=0.54.0,<0.55`.
...
from PyPI `hedron>=0.54.0,<0.55` — [Installation](../getting-started/installation.md).
...
```bash
python -m pip install -U "hedron>=0.54.0,<0.55"
python -m pip install "hedron[maps]>=0.54.0,<0.55"
python -m pip install "hedron[data]>=0.54.0,<0.55"
python -m pip install "hedron[charts]>=0.54.0,<0.55"
...
python -m pip install "hedron[data]>=0.54.0,<0.55"
python -m pip install "hedron[charts]>=0.54.0,<0.55"
python -m pip install "hedron[elements]>=0.54.0,<0.55"
python -m pip install "hedron-charts>=0.2.0,<0.3"
```
...
- Pin `hedron>=0.54.0,<0.55`. Charts remain on `hedron-charts>=0.2.0,<0.3`.
