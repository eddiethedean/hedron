...
**0.29 train** (**Published**; last **v0.29.0**): production-grade charts/native — [What’s new in 0.28](whats-new-0.28.md) · [What’s ready](whats-ready.md).
...
<div class="hedron-grid">
  ...
  <a class="hedron-card" href="upgrade/">
    ...
    <p>Upgrade to the living 0.29 train (also under Project → Upgrade).</p>
  </a>
