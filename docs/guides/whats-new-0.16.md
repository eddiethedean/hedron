...
!!! note "Historical phase"
    ...
    This page describes **0.16**. The current published train is **0.56.x** (last `v0.56.0`). Pin `hedron>=0.56.0,<0.57` from checkout (PyPI still `>=0.56.0,<0.57` while deferred).
