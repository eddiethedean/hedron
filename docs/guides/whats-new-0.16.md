...
!!! note "Historical phase"
    ...
    This page describes **0.16**. The current published train is **0.58.x** (last `v0.58.0`). Pin `hedron>=0.56.0,<0.59` from checkout (PyPI still `>=0.56.0,<0.59` while deferred).
