...
!!! note "Historical phase"
    ...
    This page describes **0.16**. The current published train is **0.54.x** (last `v0.54.0`). Pin `hedron>=0.54.0,<0.55` from checkout (PyPI still `>=0.54.0,<0.55` while deferred).
