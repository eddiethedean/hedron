...
|---|---:|---|---|---|
| `hedron` | `1.0.4` | Stable | `hedron>=1.0.0` | FastAPI-native component and route authoring |
| `hedron-data` | `1.0.4` | Stable | `hedron-data>=1.0.0` | DataTable, DataEditor, and bounded data contracts |
| `hedron-charts` | `1.0.4` | Stable | `hedron-charts>=1.0.0` | First-party charts and static/Matplotlib output |
| `hedron-maps` | `1.0.4` | Stable | `hedron-maps>=1.0.0` | Bounded first-party maps and offline presentation |
| `edron` | `1.0.4` | Stable | `edron>=1.0.0` | Alternate class-oriented facade over Hedron |
