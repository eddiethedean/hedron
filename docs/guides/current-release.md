...
|---|---:|---|---|---|
| `hedron` | `1.0.16` | Stable | `hedron>=1.0.0` | FastAPI-native component and route authoring |
| `hedron-data` | `1.0.16` | Stable | `hedron-data>=1.0.0` | DataTable, DataEditor, and bounded data contracts |
| `hedron-charts` | `1.0.16` | Stable | `hedron-charts>=1.0.0` | First-party charts and static/Matplotlib output |
| `hedron-maps` | `1.0.16` | Stable | `hedron-maps>=1.0.0` | Bounded first-party maps and offline presentation |
| `edron` | `1.0.16` | Stable | `edron>=1.0.0` | Alternate class-oriented facade over Hedron |
...
For a new Hedron application use `hedron>=1.0.16,<1.1`; for reproducible CI and deployment,
resolve and commit a lockfile or use `hedron==1.0.16`. Reusable libraries may use the broader
