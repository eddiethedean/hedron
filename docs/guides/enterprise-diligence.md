...
|---|---|
| License | MIT |
| Current version | **v0.49.0** in-tree (pin `hedron>=0.49.0,<0.50`; PyPI still `0.47.0`, tag/PyPI deferred) |
...
Prefer GitHub Release assets for the latest **uploaded** tag **`v0.47.0`** (SBOM / license /
