...
|---|---|
| License | MIT |
| Current version | Published **v1.0.4**; application requirement `hedron>=1.0.0` |
| Publication / commercial SLA | Hedron `1.0.4` and Edron `1.0.4` are on PyPI; **no commercial SLA** |
