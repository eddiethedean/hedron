...
|---|---|
| License | MIT |
| Current version | Published **v1.0.3**; application requirement `hedron>=1.0.0` |
| Publication / commercial SLA | Hedron `1.0.3` and Edron `1.0.3` are on PyPI; **no commercial SLA** |
