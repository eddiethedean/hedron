...
**Status:** Accepted; kept current with the **0.44.x** published train (tip `v0.44.0`)
...
| `hedron` | `hedron` | `hedron-core`, FastAPI; Starlette through FastAPI | `v0.2.0` (current train `0.44.x`) |
