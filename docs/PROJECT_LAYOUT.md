...
**Status:** Accepted; kept current with the **0.38.x** published train (tip `v0.38.0`)
...
| `hedron` | `hedron` | `hedron-core`, FastAPI; Starlette through FastAPI | `v0.2.0` (current train `0.38.x`) |
...
| `hedron-workbench` | `hedron_workbench` | `hedron-posit`; Posit Workbench compatibility; also `hedron[workbench]` | `v0.29.0` (current 0.38.x compatibility subclass) |
...
**Publish note:** the coordinated published train tip is **`v0.38.0`** — see
[STATUS](STATUS.md).
