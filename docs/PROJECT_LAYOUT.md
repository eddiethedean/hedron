...
**Status:** Accepted; kept current with the **0.50.x** published train (tip `v0.50.3`)
...
| `hedron-elements` | `hedron_elements` | Beta Web Component ABI (Supported inventory only); also `hedron[elements]` | `v0.50.3` |
| `hedron-workbench` | `hedron_workbench` | `hedron-posit`; Posit Workbench compatibility; also `hedron[workbench]` | `v0.50.3` |
| `hedron-posit` | `hedron_posit` | `hedron`, `fastapi-workbench`; unified Posit facade; also `hedron[posit]` | `v0.50.3` |
...
**Publish note:** the coordinated in-tree train tip is **`v0.50.3`** (latest on PyPI **`v0.50.1`**) — see
[STATUS](STATUS.md).
