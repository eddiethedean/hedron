...
**Status:** Maintainer reference for the published **0.62.x** train; PyPI and the
verified repository tip are **0.62.0**.
...
| `hedron` | `hedron` | `hedron-core`, FastAPI; Starlette through FastAPI | `v0.2.0` (current train `0.62.x`) |
...
**Publish note:** the coordinated repository train tip and PyPI release are **`v0.62.0`**
