...
**Roadmap position:** `v1.0.7` is Verified, tagged, and published on PyPI, including Edron.
...
`hedron-charts`, and `hedron-maps` `1.0.7`. Beta satellites — `hedron-explorer`,
`hedron-flask`, `hedron-django`, `hedron-jinja`, `hedron-conformance`, `hedron-extras`,
and `hedron-elements` `1.0.7`; `hedron-posit` `1.0.7`; `fastapi-workbench` `1.0.8`;
`hedron-native` `0.1.3`; `hedron-sample-kit`, `hedron-notebook`, and `hedron-gradio` `0.2.3`;
`hedron-sim` `0.2.2`; `hedron-mcp` `0.2.5`; and `edron-sim` `0.1.0` (MIT, D-033).
