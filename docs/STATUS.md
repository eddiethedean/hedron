...
**Development workspace:** `1.1.0` is the coordinated package train implementing the open
...
**Phase focus:** Phase **1.1** is **Verified and Published** against immutable `v1.0.17`; all
required enhancement and complementary-work rows, reproducible artifacts, release approval, tags,
and registry uploads are retained. Phase **1.0** remains the verified predecessor against immutable
`v0.67.0`; all 17
...
but the evidence packet is not yet Verified. Prior
...
- Ownership: [RFC-0093](rfcs/RFC-0093-HDJ-PARITY-AND-REGISTRY-INTEGRATION.md) / D-111 / D-112.
- Plan and public contract: [HDJ_PARITY_066](implementation/HDJ_PARITY_066.md) ·
  [App-scoped HDJ binding](api/HDJ_PARITY_066.md).
- Acceptance: [RELEASE_0_66](acceptance/RELEASE_0_66.md) ·
  [release-gate-0.66.toml](acceptance/release-gate-0.66.toml) ·
  [capability inventory](acceptance/hdj-parity-capability-inventory-066.toml) ·
  [open-issue inventory](acceptance/open-issues-066.toml).
...
- Ownership: [RFC-0089](rfcs/RFC-0089-CUSTOM-THEME-PLATFORM.md) / D-108.
- Plan: [THEME_PLATFORM_060](implementation/THEME_PLATFORM_060.md) ·
  [EXECUTION_0_60](implementation/EXECUTION_0_60.md) · [RELEASE_0_60](acceptance/RELEASE_0_60.md).
- Locks: [theme-platform-contract-060.toml](acceptance/theme-platform-contract-060.toml) ·
  [theme-platform-inventory-060.toml](acceptance/theme-platform-inventory-060.toml) ·
  [theme-platform-tracking-060.toml](acceptance/theme-platform-tracking-060.toml) ·
  [theme-platform-compatibility-060.toml](acceptance/theme-platform-compatibility-060.toml) ·
  [upgrade-fixtures-060.md](acceptance/upgrade-fixtures-060.md).
...
tag and PyPI published; D-074 / D-077 / [RFC-0072](rfcs/RFC-0072-TYPED-INTERACTION-ECOSYSTEM.md);
