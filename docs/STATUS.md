...
- Closure index: [release-gate-0.15.toml](acceptance/release-gate-0.15.toml)
  (all `Verified`; zero-Deferred for 0.15-owned rows).
- Acceptance: [RELEASE_0_15.md](acceptance/RELEASE_0_15.md).
...
- Cut procedure: [RELEASE.md](RELEASE.md) (current cut target: **0.15**; next capability: **0.16**).

## Next capability phase

**0.16** — workbench / extras surface. Track progress in [ROADMAP.md](ROADMAP.md) and
