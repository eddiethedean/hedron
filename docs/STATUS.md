...
[RFC-0071](rfcs/RFC-0071-TYPE-DRIVEN-AUTHORING.md)). It adds explicit Pydantic boundary models,
...
[RFC-0071](rfcs/RFC-0071-TYPE-DRIVEN-AUTHORING.md); all 0.44 gates Planned; see
