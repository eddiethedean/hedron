...
- Closure index: [release-gate-0.14.toml](acceptance/release-gate-0.14.toml)
  (all `Verified`; zero-Deferred for 0.14-owned rows).
- Acceptance: [RELEASE_0_14.md](acceptance/RELEASE_0_14.md).
...
- Cut procedure: [RELEASE.md](RELEASE.md) (next capability cut: **0.15**).

## Next capability phase

**0.15** — data-app surface completeness. Track progress in [ROADMAP.md](ROADMAP.md) and
