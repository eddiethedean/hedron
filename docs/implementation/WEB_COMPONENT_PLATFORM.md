...
This document specifies implementation boundaries for phases 0.33–0.38. Names are descriptive
...
modules and source maps according to release policy. Phase 0.36 may publish identical module content
...
| Draft | Unsubmitted edit, staged selection | User-local and bounded; explicit submit/discard/conflict and optional 0.37 transfer |
...
The phase 0.37 transfer protocol keys eligible draft state by component instance, schema version,
...
Stable tag/event contracts begin only with the 0.38 inventory.
