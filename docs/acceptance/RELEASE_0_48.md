...
- [x] Stage 0 contract remains the consume-shipped baseline; Stage 1 shipped the 0.48 runtime.
- [x] Verified 0.47 and a tracking issue are bound before Stage 1
  ([#373](https://github.com/eddiethedean/hedron/issues/373)).
- [x] Stage 1 measures and locks asset, connection, amplification, lifecycle, and performance limits.
