...
The cut must integrate all four currently open styling issues:
...
| `PRESENT-065` | broader styling verticals and preference matrix |
...
owners for #690/#693/#694/#698, and exact commands for every gate. Exit requires no unexplained
private-selector dependency, no silent CSS omission, no unowned token or asset, no accessibility
regression, and no new Supported claim for a Progressive/Deferred surface.
