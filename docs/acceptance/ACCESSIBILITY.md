...
- [ ] Charts: title/description or waiver, static alt text, tabular fallback, and real-browser/AT
  behavior for supported charts. *(0.6 closure; see [VISUALIZATION](VISUALIZATION.md))*
