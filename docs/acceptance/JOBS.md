...
| JOB-006 | Optional SSE, if selected, preserves the same job contract and passes offline/CSP/auth/reconnect tests; otherwise polling remains sufficient. | Accepted transport decision and extension evidence, or explicit post-1.0 deferment. | Deferred |
