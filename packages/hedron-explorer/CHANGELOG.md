...
- Align the explorer package with the coordinated 1.1.1 release train.
...
### Changed
- Aligned the Explorer package and coordinated package metadata with the Phase 0.67 release
  train.
...
### Changed
- Adopted the 0.61 action-state and async-boundary metadata contract for read-only inspection.
