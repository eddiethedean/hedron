...
- Align Workbench package metadata with the Hedron 1.0 coordinated train.

## [0.67.0] — 2026-08-27

### Changed
- Aligned the Workbench compatibility adapter and coordinated package metadata with the Phase
  0.67 release train.
...
### Added
- 0.64 presentation and HTMX lifecycle compatibility for Workbench hosts.
...
### Changed
- Retained the compatibility facade on the 0.62 coordinated train; new features remain owned by `hedron-posit`.
