...
**Package maturity:** Beta · **Train:** `0.36.x` (last published `0.36.0`) · pin `>=0.36.0,<0.37`

## Install

```bash
pip install "hedron-data>=0.36.0,<0.37"
# or
uv add "hedron-data>=0.36.0,<0.37"
# via flagship:
pip install "hedron[data]>=0.36.0,<0.37"
```
...
```bash
pip install "hedron-data[dataframes]>=0.36.0,<0.37"
pip install "hedron-data[sqlalchemy]>=0.36.0,<0.37"
```
