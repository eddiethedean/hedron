...
from hedron_posit._workbench.codes import FWB_0001, FWB_0002, FWB_0008
...
from hedron_posit._workbench.mount import cookie_path_for_mount, normalize_mount_path
from hedron_posit._workbench.urls import normalize_http_origin
    ...
    for entry in entries:
        if entry == "*":
            raise _error(
                ...
                explanation="Wildcard forwarded proxy trust is not accepted by hedron-posit.",
