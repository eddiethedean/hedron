...
from hedron_posit._workbench.codes import FWB_0002, FWB_0003, FWB_0004, FWB_0005, FWB_0009
from hedron_posit._workbench.config import ResolvedDeployment, WorkbenchConfig
from hedron_posit._workbench.detect import is_workbench_job, rs_server_url
from hedron_posit._workbench.diagnostics import WorkbenchError, make_diagnostic
from hedron_posit._workbench.middleware import workbenchify
from hedron_posit._workbench.redact import redact_text
from hedron_posit._workbench.resolve import (
    RESOLVED_MODE_ENV,
    RESOLVED_MOUNT_ENV,
...
def export_workbench_state(
    ...
    *,
    ...
    if resolved.active and resolved.external_origin:
        ...
        env[RESOLVED_PUBLIC_BASE_ENV] = f"{origin}{mount}" if mount and mount != "/" else origin
...
def supervised_uvicorn_command(
    ...
    *,
    ...
    command = [
        ...
        "-m",
        "uvicorn",
        "hedron_posit._workbench.runner:app_from_environ",
        "--factory",
        "--fd",
        str(fd),
        "--proxy-headers",
