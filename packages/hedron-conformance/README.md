...
```bash
pip install "hedron-conformance>=0.63.0,<0.64"
# or
uv add "hedron-conformance>=0.63.0,<0.64"
# via flagship:
pip install "hedron[conformance]>=0.63.0,<0.64"
```

Checkout tip `v0.63.0` uses `uv sync`; applications install `>=0.63.0,<0.64` from PyPI.
