...
```bash
pip install "hedron-conformance>=0.64.0,<0.65"
# or
uv add "hedron-conformance>=0.64.0,<0.65"
# via flagship:
pip install "hedron[conformance]>=0.64.0,<0.65"
```

Checkout tip `v0.64.0` uses `uv sync`; applications install `>=0.64.0,<0.65` from PyPI.
