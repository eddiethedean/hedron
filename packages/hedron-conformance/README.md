...
# or
uv add "hedron-conformance>=0.56.0,<0.57"
# via flagship:
pip install "hedron[conformance]>=0.56.0,<0.57"
```

Checkout tip `v0.55.0` uses `>=0.56.0,<0.57` in-tree; PyPI first-run stays `>=0.54.0,<0.55` until the Git tag / PyPI upload lands.
