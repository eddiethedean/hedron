...
```bash
pip install "hedron-conformance>=0.66.2,<0.67"
# or
uv add "hedron-conformance>=0.66.2,<0.67"
# via flagship:
pip install "hedron[conformance]>=0.66.2,<0.67"
```

Checkout tip `v0.66.2` uses `uv sync`; applications install `>=0.66.2,<0.67` from PyPI.
