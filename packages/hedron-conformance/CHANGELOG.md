...
- Coordinate the 1.0.11 bug-fix release metadata.
...
### Changed
- Aligned the conformance package and coordinated package metadata with the Phase 0.67 release
  train.
...
### Added
- 0.64 presentation and HTMX lifecycle conformance integration.
...
### Added
- Phase 0.61 conformance coverage for unified action state, async regions, trace redaction, and fallback semantics.
...
- Portable-subset authority extensions: profiles, fixture compile, sandbox, signed reports.
...
### Added
- AppScenario coverage for included package features.
...
### Added
- Phase 0.45 portable catalog fixtures and evaluator JSON checks.
...
- Coordinated Beta train with phase 0.15; fixture kit remains language-neutral and
  versioned independently of data-app UI surface additions.

## [0.14.0] — 2026-08-05

### Added

- Initial language-neutral conformance kit: fixture schema, bundled goldens,
  normalization rules, and capability-level runner CLI (`hedron-conformance`).
