...
- Align the Jinja adapter with the coordinated 1.1.1 release train.
...
- Align HDJ package metadata with the Hedron 1.0 coordinated train.
- Broaden MarkupSafe compatibility to `>=2.1.1,<4`.

## [0.67.0] — 2026-08-27

### Changed
- Aligned the Jinja/HDJ adapter and coordinated package metadata with the Phase 0.67 release
  train.
...
### Added
- 0.64 presentation contract compatibility for Jinja hosts.
...
### Changed
- Adopted the 0.62 coordinated core train and server-first interaction markers.
...
### Added
- list_feature_bundles for HDJ inspection; no workflow store.
...
### Added
- Phase 0.45 registered-handle catalog helpers; no annotation eval or manifest execution.
