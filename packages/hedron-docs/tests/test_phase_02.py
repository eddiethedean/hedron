...
def test_phase_02_manifest_is_a_clean_schema_break(tmp_path: Path) -> None:
    ...
    with pytest.raises(ValueError, match="hedron-docs-manifest-4"):
    ...
    assert serialized["schema_version"] == "hedron-docs-manifest-4"
    assert serialized["compiler_version"] == "0.4.0"
