...
- Align optional extras with the coordinated 1.1.1 release train.
...
- Bound nested `TreeView` traversal and enforce required `ChoiceCards` selections.
...
- Align extras package metadata with the Hedron 1.0 coordinated train.
