"""Django TypeSchema disposition (TA-QUAL-003): bounded exception, no FastAPI DI."""
...
def refuse_fastapi_type_authoring(*, feature: str = "ViewParams/FormBody") -> None:
    ...
    raise error(
        HED_TYPE_0009,
        title="Type-driven authoring is not emulated on Django",
        explanation=(
            f"{feature} request binding requires FastAPI DI; hedron-django does not emulate it."
        ),
