...
- Publish the current recording and simulator asset fixes under a new immutable version.

## [0.2.2] — 2026-08-27

### Fixed

- Publish the Hedron 1.0-compatible core and flagship dependency metadata under
  a new immutable patch version.

## [0.2.1] — 2026-08-24

### Changed
- Updated the core and flagship compatibility floors for the 0.62 interaction train.
