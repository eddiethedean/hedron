...
**Package maturity:** Beta · **Repository train:** `0.60.x` · **Repository tip:** `0.60.2` · **Latest PyPI release:** `0.60.2` · **Application pin:** `>=0.61.0,<0.62`
...
```bash
uv add "hedron[data,dev]>=0.61.0,<0.62"
```
