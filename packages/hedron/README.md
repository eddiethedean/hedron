...
[![Docs](https://img.shields.io/readthedocs/hedron?style=flat&label=docs)](https://hedron.readthedocs.io/en/latest/)
...
[![Hedron Showcase workspace overview using Folio](https://raw.githubusercontent.com/eddiethedean/hedron/main/docs/assets/hedron-showcase.jpg)](https://hedron.readthedocs.io/en/latest/examples/showcase/)
...
> 3.10–3.14; applications should require the `>=1.0.0` stable compatibility floor shown below.
