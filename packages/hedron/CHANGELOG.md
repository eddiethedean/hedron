...
- Reject captured-state closures from cache decorators instead of conflating their entries.
...
- Refreshed the published documentation badge rendering.
...
- Vertically center text inside AppShell environment badges.
...
### Added
- Bounded presentation contracts and opt-in Hedron HTMX lifecycle projection for the 0.66 train.
