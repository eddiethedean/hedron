...
- Align elements with the coordinated 1.1.1 release train.
...
- Align elements package metadata with the Hedron 1.0 coordinated train.

## [0.67.0] — 2026-08-27

### Changed
- Aligned the Web Component ABI package and coordinated package metadata with the Phase 0.67
  release train.
