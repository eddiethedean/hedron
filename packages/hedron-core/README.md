...
**Package maturity:** Beta · pin `>=0.56.0,<0.58` from PyPI. The living in-tree tip is
**`v0.57.0`**; PyPI serves **0.56.0** (0.57.0 tag/upload deferred).

## Install

```bash
pip install "hedron-core>=0.56.0,<0.58"
# or
uv add "hedron-core>=0.56.0,<0.58"
# In-tree / source checkout tip:
# pip install "hedron-core>=0.57.0,<0.58"
```
