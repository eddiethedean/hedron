...
**Package maturity:** Beta · pin `>=0.60.0,<0.61` from PyPI. The living in-tree tip and
latest public PyPI release are **`v0.60.0`**.

## Install

```bash
pip install "hedron-core>=0.60.0,<0.61"
# or
uv add "hedron-core>=0.60.0,<0.61"
