...
**Package maturity:** Beta · pin `>=0.51.0,<0.52` from PyPI. The living in-tree tip is
**`v0.51.2`**; Git tag and PyPI upload for that patch are **deferred**.

## Install

```bash
pip install "hedron-core>=0.51.0,<0.52"
# or
uv add "hedron-core>=0.51.0,<0.52"
```
