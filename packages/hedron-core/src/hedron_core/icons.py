...
_FIRST_PARTY_PATHS: dict[str, str] = {
    ...
    "team": (
        ...
        "M9 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8m7-7a4 4 0 0 1 0 7"
    ),
    "database": "M4 5c0 2 16 2 16 0M4 5v14c0 2 16 2 16 0V5M4 12c0 2 16 2 16 0",
    "pipeline": "M4 4h6v6H4zM14 14h6v6h-6zM10 7h4v10h-4",
    "link": (
    ...
    "settings": (
        ...
        "M19.4 15a1.7 1.7 0 0 0 .3 1.9l.1.1-1.8 1.8-.1-.1a1.7 1.7 0 0 0-1.9-.3"
        " 1.7 1.7 0 0 0-1 1.5v.1h-2.6v-.1a1.7 1.7 0 0 0-1-1.5 1.7 1.7 0 0 0-1.9.3"
        "l-.1.1-1.8-1.8.1-.1A1.7 1.7 0 0 0 8 15a1.7 1.7 0 0 0-1.5-1H6v-2.6h.1a1.7 1.7 0 0 0 1.5-1"
        " 1.7 1.7 0 0 0-.3-1.9l-.1-.1L9 6.6l.1.1a1.7 1.7 0 0 0 1.9.3 1.7 1.7 0 0 0 1-1.5v-.1h2.6v.1"
        "a1.7 1.7 0 0 0 1 1.5 1.7 1.7 0 0 0 1.9-.3l.1-.1 1.8 1.8-.1.1a1.7 1.7 0 0 0-.3 1.9"
        " 1.7 1.7 0 0 0 1.5 1h.1V14h-.1a1.7 1.7 0 0 0-1.1 1z"
    ),
    ...
    "eye-off": (
        "m3 3 18 18M10.6 6.2A10.7 10.7 0 0 1 12 6c6.5 0 10 6 10 6a18 18 0 0 1-4 4.7"
        "M6.2 6.2C3.5 8.2 2 12 2 12s3.5 6 10 6a10.7 10.7 0 0 0 1.4-.1"
    ),
}
