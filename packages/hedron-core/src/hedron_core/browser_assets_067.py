...
ALPINE_067_ARTIFACTS: Mapping[str, AlpineArtifact] = MappingProxyType(
    {
        "core": AlpineArtifact(
            ...
            "MIT",
            f"{_GITHUB}/packages/csp",
            "/hedron-static/alpine/csp-3.16.3.js",
        ),
        "anchor": AlpineArtifact(
            ...
            "MIT",
            f"{_NPM}/@alpinejs/anchor",
            "/hedron-static/alpine/anchor-3.16.3.js",
        ),
        "collapse": AlpineArtifact(
            ...
            "MIT",
            f"{_NPM}/@alpinejs/collapse",
            "/hedron-static/alpine/collapse-3.16.3.js",
        ),
        "focus": AlpineArtifact(
            ...
            "MIT",
            f"{_NPM}/@alpinejs/focus",
            "/hedron-static/alpine/focus-3.16.3.js",
        ),
        "intersect": AlpineArtifact(
            ...
            "MIT",
            f"{_NPM}/@alpinejs/intersect",
            "/hedron-static/alpine/intersect-3.16.3.js",
        ),
        "mask": AlpineArtifact(
            "@alpinejs/mask",
            "3.16.3",
            ...
            "MIT",
            f"{_NPM}/@alpinejs/mask",
            "/hedron-static/alpine/mask-3.16.3.js",
        ),
        "morph": AlpineArtifact(
            ...
            "MIT",
            f"{_NPM}/@alpinejs/morph",
            "/hedron-static/alpine/morph-3.16.3.js",
            "Progressive",
        ),
        "persist": AlpineArtifact(
            ...
            "MIT",
            f"{_NPM}/@alpinejs/persist",
            "/hedron-static/alpine/persist-3.16.3.js",
            "Progressive",
        ),
        "resize": AlpineArtifact(
            ...
            "MIT",
            f"{_NPM}/@alpinejs/resize",
            "/hedron-static/alpine/resize-3.16.3.js",
        ),
        "sort": AlpineArtifact(
            "@alpinejs/sort",
            "3.16.3",
            ...
            "MIT",
            f"{_NPM}/@alpinejs/sort",
            "/hedron-static/alpine/sort-3.16.3.js",
            "Progressive",
        ),
        "ui": AlpineArtifact(
            "@alpinejs/ui",
            ...
            "MIT",
            f"{_GITHUB}/packages/ui",
            "/hedron-static/alpine/ui-3.16.3.js",
            "Progressive",
        ),
    }
)
