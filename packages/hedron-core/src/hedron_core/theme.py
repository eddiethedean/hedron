...
def default_theme() -> Theme:
    return Theme(
        ...
        tokens={
            ...
            "chart.grid": "#cbd5e1",
            "chart.label": "#172033",
            "chart.selection": "#2563eb",
            "chart.focus": "#2563eb",
            "chart.surface": "#ffffff",
            "chart.tooltip-bg": "#172033",
        ...
        modes={
            "dark": {
                ...
                "color.fg": "#eef3fa",
                "color.accent": "#7ca7ff",
                "color.accent-hover": "#a2c0ff",
                "color.accent-soft": "#1d3158",
                "color.border": "#2c3748",
                "color.border-strong": "#3b485c",
                ...
                "color.info-soft": "#193453",
                "color.selection-bg": "#254575",
                "color.selection-fg": "#eef3fa",
                "color.muted": "#9ba8ba",
                "focus.ring": "3px solid #7ca7ff",
                "chart.axis": "#9ba8ba",
                "chart.grid": "#475569",
                "chart.label": "#eef3fa",
                "chart.selection": "#7ca7ff",
                "chart.focus": "#7ca7ff",
                "chart.surface": "#151c28",
                "chart.tooltip-bg": "#eef3fa",
                "chart.tooltip-fg": "#0d121c",
...
def aurora_theme() -> Theme:
    ...
    return Theme(
        ...
        tokens={
            ...
            "color.focus": "#6d3ce7",
            "color.danger": "#b4234d",
            "color.danger-soft": "#ffe8ef",
            "color.on-danger": "#ffffff",
            "color.success": "#087a57",
            "color.success-soft": "#dcf8ed",
            "color.warning": "#8a5800",
            "color.warning-soft": "#fff1cc",
            "color.info-soft": "#e9ddff",
            "color.selection-bg": "#ddd0ff",
            "color.selection-fg": "#221a35",
            "color.muted": "#675e78",
            ...
            "chart.grid": "#c4b5fd",
            "chart.label": "#221a35",
            "chart.selection": "#6d3ce7",
            "chart.focus": "#6d3ce7",
            "chart.surface": "#ffffff",
            "chart.tooltip-bg": "#221a35",
            "chart.tooltip-fg": "#ffffff",
            "surface.translucent.opacity": "78%",
            "surface.translucent.blur": "8px",
            "surface.glass.opacity": "72%",
            "surface.glass.blur": "14px",
            "surface.glass.border": "rgb(255 255 255 / 42%)",
        },
        modes={
            "dark": {
                "color.bg": "#120d1f",
                ...
                "color.fg": "#f8f4ff",
                "color.accent": "#c4a7ff",
                "color.accent-hover": "#dccbff",
                "color.accent-soft": "#352252",
                "color.border": "#3a2c51",
                "color.border-strong": "#4e3a6a",
                "color.on-accent": "#20123a",
                "color.focus": "#c4a7ff",
                "color.danger": "#ff87a9",
                "color.danger-soft": "#4a1d2e",
                "color.on-danger": "#3d0718",
                "color.success": "#6ee7b7",
                "color.success-soft": "#153b31",
                "color.warning": "#f5c76f",
                "color.warning-soft": "#40331d",
                "color.info-soft": "#30204d",
                "color.selection-bg": "#463263",
                "color.selection-fg": "#f8f4ff",
                "color.muted": "#b9abc9",
                "focus.ring": "3px solid #c4a7ff",
                "chart.axis": "#b9abc9",
                "chart.grid": "#4e3a6a",
                "chart.label": "#f8f4ff",
                "chart.selection": "#c4a7ff",
                "chart.focus": "#c4a7ff",
                "chart.surface": "#1d162d",
                "chart.tooltip-bg": "#f8f4ff",
                "chart.tooltip-fg": "#120d1f",
                "surface.glass.border": "rgb(255 255 255 / 24%)",
            }
        },
    )
