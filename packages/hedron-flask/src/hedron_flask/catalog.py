"""Flask portable catalog facts (EC-HOST-002). No FastAPI DI / TypeSchema production."""
...
def refuse_live_host_authority(*, field: str) -> None:
    ...
    raise error(
        HED_PROJECTION_0005,
        title="Flask host fact is not portable",
        explanation=f"{field} remains live-host-authoritative on Flask.",
        remediation="Read mount/session/CSRF/reversal from the Flask request, not the catalog.",
