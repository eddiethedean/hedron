...
- [docs/acceptance/RELEASE_0_27.md](docs/acceptance/RELEASE_0_27.md) (Planned)
- [docs/acceptance/release-gate-0.27.toml](docs/acceptance/release-gate-0.27.toml) (Planned)
- [docs/acceptance/production-grade-inventory-027.toml](docs/acceptance/production-grade-inventory-027.toml)
- [docs/acceptance/upgrade-fixtures-027.md](docs/acceptance/upgrade-fixtures-027.md) (Planned)
...
| Production-grade data, Flask/Django adapters, HDJ authoring, and curated extras | 0.27 | Planned; D-055 / RFC-0058; gates `DATA-027`…`PKG-027` — [RELEASE_0_27](docs/acceptance/RELEASE_0_27.md). |
