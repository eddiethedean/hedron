...
[What’s new in 0.47](https://hedron.readthedocs.io/en/latest/guides/whats-new-0.47/) ·
...
| [`hedron-data`](https://pypi.org/project/hedron-data/) | DataTable / DataEditor (also `pip install "hedron[data]>=0.48.0,<0.49"`) |
...
Charts require the fixed satellite floor: `pip install "hedron[charts]>=0.48.0,<0.49"`.
