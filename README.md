...
Pin installs with `hedron>=0.36.0,<0.37`. Full walkthrough:
...
| [`hedron-data`](https://pypi.org/project/hedron-data/) | DataTable / DataEditor (also `pip install "hedron[data]>=0.36.0,<0.37"`) |
...
Charts require the fixed satellite floor: `pip install "hedron[charts]>=0.36.0,<0.37"`.
