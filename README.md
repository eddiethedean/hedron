...
uvx --from "hedron>=0.28.2,<0.29" hedron new my-hedron-app
...
Pin installs with `hedron>=0.28.2,<0.29`. Full walkthrough:
...
| [`hedron-data`](https://pypi.org/project/hedron-data/) | DataTable / DataEditor (also `pip install "hedron[data]>=0.28.2,<0.29"`) |
...
Charts require the fixed satellite floor: `pip install "hedron[charts]>=0.28.2,<0.29"`.
