...
Pin installs with `hedron>=0.26.0,<0.27`. Full walkthrough:
...
| [`hedron-data`](https://pypi.org/project/hedron-data/) | DataTable / DataEditor (also `pip install "hedron[data]>=0.26.0,<0.27"`) |
...
Charts require the fixed satellite floor: `pip install "hedron[charts]>=0.26.0,<0.27"`.
