...
Install from PyPI: `hedron>=0.51.0,<0.52`. Pins and extras:
...
[What’s new in 0.50](https://hedron.readthedocs.io/en/latest/guides/whats-new-0.50/) ·
...
| [`hedron-data`](https://pypi.org/project/hedron-data/) | DataTable / DataEditor (also `pip install "hedron[data]>=0.51.0,<0.52"`) |
...
Charts: `pip install "hedron[charts]>=0.51.0,<0.52"`.
Maps: `pip install "hedron[maps]>=0.51.0,<0.52"`.
