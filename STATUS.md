...
- Closure index: [release-gate-0.12.toml](docs/acceptance/release-gate-0.12.toml)
  (all `Verified`; D-047 zero-Deferred policy).
- Acceptance: [RELEASE_0_12.md](docs/acceptance/RELEASE_0_12.md).
...
- Cut procedure: [RELEASE.md](docs/RELEASE.md) (next cut: **0.13**).

## Next capability phase

**0.13** — advanced async and observability. Track progress in [ROADMAP.md](docs/ROADMAP.md) and
