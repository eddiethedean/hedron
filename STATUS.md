...
[0.35 acceptance packet](docs/acceptance/RELEASE_0_35.md). Next: Web Component platform
phase **0.36** is Stage 0 refined (D-064 / [RFC-0060](docs/rfcs/RFC-0060-WEB-COMPONENT-PLATFORM.md)
**Accepted**; [#92](https://github.com/eddiethedean/hedron/issues/92)); see
[implementation plan](docs/implementation/HEDRON_ELEMENTS_036.md) and
