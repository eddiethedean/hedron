...
- Cut procedure: [RELEASE.md](docs/RELEASE.md) (last published: **0.16**; next capability: **0.17**).

## Next capability phase

**0.17** — reactive dashboards and agent interfaces (also shell NavLink/OobHost/`class_`
primitives; landmark a11y attrs/types land in **0.19**). Track progress in [ROADMAP.md](docs/ROADMAP.md)
