...
- Closure index: [release-gate-0.13.toml](docs/acceptance/release-gate-0.13.toml)
  (all `Verified`; zero-Deferred for 0.13-owned rows).
- Acceptance: [RELEASE_0_13.md](docs/acceptance/RELEASE_0_13.md).
...
- Cut procedure: [RELEASE.md](docs/RELEASE.md) (next capability cut: **0.14**).

## Next capability phase

**0.14** — portable runtimes and acceleration. Track progress in [ROADMAP.md](docs/ROADMAP.md) and
