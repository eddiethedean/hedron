...
- Closure index: [release-gate-0.19.toml](docs/acceptance/release-gate-0.19.toml)
  (all `Verified`; zero-Deferred for 0.19-owned rows).
- Acceptance: [RELEASE_0_19.md](docs/acceptance/RELEASE_0_19.md).
...
- Cut procedure: [RELEASE.md](docs/RELEASE.md) (last published: **0.19**; next capability: **0.20**).
