...
- Closure index: [release-gate-0.17.toml](docs/acceptance/release-gate-0.17.toml)
...
- Cut procedure: [RELEASE.md](docs/RELEASE.md) (last published: **0.17**; next capability: **0.18**).

## Next capability phase

**0.18** — model demos and inference workflows. Track progress in [ROADMAP.md](docs/ROADMAP.md)
and the public [roadmap guide](docs/guides/roadmap.md).
