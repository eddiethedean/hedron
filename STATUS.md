...
**Roadmap position:** phase 0.28 **Published** as `v0.28.0` (2026-08-10); last published
PyPI/git = `v0.28.0`. Prior: 0.27 **Published** as `v0.27.0`.
**Date:** 2026-08-10
**Implementation:** Beta — `hedron` / `hedron-core` / `hedron-explorer` / `hedron-data` /
`hedron-flask` / `hedron-django` / `hedron-jinja` / `hedron-conformance` / `hedron-extras`
`0.28.0`; Beta (independent) — `hedron-charts` `0.1.8`, `hedron-native` `0.1.1`; Alpha —
`hedron-sample-kit` `0.1.8`, `hedron-notebook` / `hedron-mcp` / `hedron-gradio` `0.1.0`
(MIT, D-033).
...
Baseline: Published **`v0.27.0`**. Packages: `hedron-charts` `0.1.8` / `hedron-native`
`0.1.1` — **Beta** for declared Supported inventories.
...
(`v0.27.0`; D-055). Phase **0.28** is **Published** (`v0.28.0`; D-056 / RFC-0059).
