...
- Decision: D-052; RFC baseline [RFC-0055](docs/rfcs/RFC-0055-A11Y-GOVERNANCE.md) (amended).
- Gate index: [release-gate-0.21.toml](docs/acceptance/release-gate-0.21.toml) (all `Planned`).
