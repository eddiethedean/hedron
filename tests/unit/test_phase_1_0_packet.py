...
def test_phase_1_0_keeps_verified_067_as_immutable_predecessor() -> None:
    ...
    assert release["previous_train"] == "1.0"
    assert release["previous_version"] == "1.0.17"
    assert release["published_version"] == release["stable_version"]
    assert release["published_version"] == release["pypi_version"]
